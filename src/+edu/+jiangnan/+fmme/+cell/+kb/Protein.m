...
classdef Protein < edu.jiangnan.fmme.cell.kb.Enzyme
    %computed properties
    ...
    methods
        function this = Protein(knowledgeBase, wid, wholeCellModelID, name,...
            ...
            this = edu.jiangnan.fmme.cell.kb.Protein.empty(size(wid,1),0);
            this(size(wid,1),1) = edu.jiangnan.fmme.cell.kb.Protein;
            for i = 1:size(wid,1)
                this(i,1).idx = i;
