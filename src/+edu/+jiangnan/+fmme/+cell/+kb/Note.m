...
classdef Note < edu.jiangnan.fmme.cell.kb.KnowledgeBaseObject
    properties
    end
    ...
    methods
        function this = Note(knowledgeBase, wid, wholeCellModelID, name, ...
            ...
            this = edu.jiangnan.fmme.cell.kb.Note.empty(size(wid,1),0);
            this(size(wid,1),1) = edu.jiangnan.fmme.cell.kb.Note;
            for i = 1:size(wid,1)
                this(i,1).idx = i;
