...
classdef dsRNA < edu.jiangnan.fmme.cell.kb.NucleicAcid
    ...
    methods
        function this = dsRNA(knowledgeBase, wid, wholeCellModelID, name, ...
            ...
            this = edu.jiangnan.fmme.cell.kb.dsRNA.empty(size(wid,1),0);
            this(size(wid,1),1) = edu.jiangnan.fmme.cell.kb.dsRNA;
            for i = 1:size(wid,1)
                this(i,1).idx = i;
