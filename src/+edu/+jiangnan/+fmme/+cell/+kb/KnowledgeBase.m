...
classdef KnowledgeBase < edu.jiangnan.fmme.cell.kb.KnowledgeBaseObject
    properties
        version
        investigator
        taxonomy
        ...
        parameters         = edu.jiangnan.fmme.cell.kb.Parameter.empty(0,0);
        processes          = edu.jiangnan.fmme.cell.kb.Process.empty(0,0);
        states             = edu.jiangnan.fmme.cell.kb.State.empty(0,0);
        compartments       = edu.jiangnan.fmme.cell.kb.Compartment.empty(0,0);
        metabolites        = edu.jiangnan.fmme.cell.kb.Metabolite.empty(0,0);
        ...
        pathways           = edu.jiangnan.fmme.cell.kb.Pathway.empty(0,0);
        stimulis           = edu.jiangnan.fmme.cell.kb.Stimuli.empty(0,0);
        notes              = edu.jiangnan.fmme.cell.kb.Note.empty(0,0);
    ...
    properties (Constant = true)
		...
		mitochondriaCompartmentWholeCellModelIDs              = {'m'};
    ...
    methods
        function this = KnowledgeBase(database, wid)
            if ~exist('wid', 'var')
                wid = edu.jiangnan.fmme.cell.kb.KnowledgeBaseUtil.selectLatestKnowledgeBase(database);
            end
            this.idx = 1;            
            this.wid = wid;
        ...
        function value = get.geneticCodeAminoAcids(this)
			...
			%value={};
            value={
			'GLN_L','MET_L','MET_L','MET_L','MET_L','ARG_L','MET_L','MET_L','MET_L','MET_L','GLY_L','PRO_L','PRO_L',...
			'PRO_L','PRO_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','PRO_L','PRO_L','PRO_L','TYR_L','TYR_L',...
			'SER_L','SER_L','SER_L','TYR_L','TYR_L','TYR_L','TYR_L','TYR_L','TYR_L','TYR_L','TYR_L','LEU_L','LEU_L',...
			'TYR_L','TYR_L','TYR_L','TYR_L','TYR_L','TYR_L','PRO_L','PRO_L','PRO_L','GLY_L','GLY_L','GLY_L','LEU_L',...
			'LEU_L','SER_L','GLU_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L',...
			'ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L',...
			'ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','ALA_L','CYS_L','CYS_L','CYS_L','CYS_L','CYS_L','CYS_L','CYS_L',...
			'CYS_L','CYS_L','CYS_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L',...
			'ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L',...
			'ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','ASP_L','GLU_L','GLU_L',...
			'GLU_L','GLU_L','GLU_L','GLU_L','GLU_L','GLU_L','GLU_L','GLU_L','GLU_L','GLU_L','GLU_L','GLU_L','GLU_L',...
			'GLU_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L',...
			'PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','PHE_L','GLY_L','GLY_L','GLY_L',...
			'GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L',...
			'GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','GLY_L','HIS_L','HIS_L',...
			'HIS_L','HIS_L','HIS_L','HIS_L','HIS_L','HIS_L','HIS_L','HIS_L','HIS_L','HIS_L','HIS_L','HIS_L','HIS_L',...
			'HIS_L','ILE_L','ILE_L','ILE_L','ILE_L','ILE_L','ILE_L','ILE_L','ILE_L','ILE_L','ILE_L','ILE_L','ILE_L',...
			'ILE_L','ILE_L','ILE_L','ILE_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L',...
			'LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L','LYS_L',...
			'LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L',...
			'LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','LEU_L','MET_L','MET_L','MET_L','ASN_L',...
			'ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','ASN_L',...
			'ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','ASN_L','PRO_L','PRO_L','PRO_L','PRO_L','PRO_L',...
			'PRO_L','GLN_L','GLN_L','GLN_L','GLN_L','GLN_L','GLN_L','GLN_L','GLN_L','GLN_L','GLN_L','ARG_L','ARG_L',...
			'ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L',...
			'ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','ARG_L','PRO_L',...
			'ARG_L','THR_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L',...
			'SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L','SER_L',...
			'SER_L','SER_L','SER_L','SER_L','SER_L','THR_L','THR_L','THR_L','THR_L','THR_L','THR_L','THR_L','THR_L',...
			'THR_L','THR_L','THR_L','THR_L','THR_L','THR_L','THR_L','THR_L','THR_L','THR_L','THR_L','THR_L','THR_L',...
			'THR_L','THR_L','THR_L','THR_L','THR_L','THR_L','THR_L','VAL_L','VAL_L','VAL_L','VAL_L','VAL_L','VAL_L',...
			'VAL_L','VAL_L','VAL_L','VAL_L','VAL_L','VAL_L','VAL_L','VAL_L','VAL_L','VAL_L','VAL_L','VAL_L','VAL_L',...
			'VAL_L','VAL_L','TRP_L','TRP_L','TRP_L','TRP_L','TRP_L','TRP_L','TRP_L','SER_L','SER_L','SER_L','SER_L',...
			'TYR_L','TYR_L'
			};
			%{
			for i=1:length(this.tRNAGenes)
        ...
        function value = get.proteinMonomerTRNASequences(this)
            ...
            dnaSequences = {genes.cdsSequence}'; %#ok<*PROP>
			%dnaSequences = {this.proteinMonomers.cdssequence}';
        ...
        function value = get.proteinChaperoneMatrix(this)
            ...
            for i=1:this.numProteinMonomers
                ...
                for j=1:length(substrates)
                    if isa(substrates(j),'edu.jiangnan.fmme.cell.kb.ProteinMonomer')
        ...
        function value = get.reactionModificationMatrix(this)
            ...
            for i = 1:this.numReactions
                ...
                for j=1:length(modifications)
                    if isa(modifications(j),'edu.jiangnan.fmme.cell.kb.ProteinMonomer')
        ...
        function value = get.reactionCatalysisMatrix(this)
            ...
            for i=1:length(this.reactions)
                ...
                if isa(enzyme,'edu.jiangnan.fmme.cell.kb.ProteinMonomer');
    ...
    methods (Access = protected)
        function loadFromKnowledgeBase(this, database)                      
           ...
           % sql='SELECT * FROM summary';
            ...
            %genome
            database.setNullValue(0);
            database.prepareStatement('select * from genomes');
            %database.prepareStatement('CALL get_genomes("{Si}",null)', this.wid);
            data = database.query();
            this.genomes = edu.jiangnan.fmme.cell.kb.Genome(...
                this, data.WID, data.WholeCellModelID, data.Name,...
                data.SequenceTopology,data.Sequence);

            %genes
            database.setNullValue(0);
            database.prepareStatement('select * from genes');
            %database.prepareStatement('CALL get_genes("{Si}",null)', this.wid);
            data = database.query();
            this.genes = edu.jiangnan.fmme.cell.kb.Gene(...
                this, data.WID, data.WholeCellModelID, data.Name, ...
                data.Symbol, data.Synonyms, data.Type, strcmp(data.StartCodon,'Y'), data.Codons, data.Coordinate, ...
                data.Direction, data.Sequence, data.CDSSequence, data.Length,  ...
                data.Essential, data.HalfLife, ...
                [data.Expression, data.ExpressionColdShock, data.ExpressionHeatShock]);

            %transcriptionUnits
            database.setNullValue(0);
            database.prepareStatement('select * from transcriptionunits');
            %database.prepareStatement('CALL get_transcriptionunits("{Si}",null)', this.wid);
            data = database.query();
            this.transcriptionUnits = edu.jiangnan.fmme.cell.kb.TranscriptionUnit(...
                this, data.WID, data.WholeCellModelID, data.Name, ...
				data.fivePrimeCoordinate, data.threePrimeCoordinate,...
                data.CCAATCoordinate, data.CCAATLength,...
                data.TATACoordinate, data.TATALength,...
                data.GCCoordinate, data.GCLength,...
                data.TSSCoordinate, data.Sequence);

            %genomeFeatures
            database.setNullValue(0);
            database.prepareStatement('select * from genomefeatures');
            %database.prepareStatement('CALL get_genomefeatures("{Si}",null)', this.wid);
            data = database.query();
            this.genomeFeatures = edu.jiangnan.fmme.cell.kb.GenomeFeature(...
                this, data.WID, data.WholeCellModelID, data.Name, ...
                data.Type, data.Subtype, data.Coordinate, data.endCoordinate, data.Length, data.Direction, data.Sequence);

            %proteinMonomers
            database.setNullValue(0);
            database.prepareStatement('select * from proteinmonomers');
            %database.prepareStatement('CALL get_proteinmonomers("{Si}",null)', this.wid);
            data = database.query();
            this.proteinMonomers = edu.jiangnan.fmme.cell.kb.ProteinMonomer(...
                this, data.WID, data.WholeCellModelID, data.Name, data.HalfLifeCalc,....
                data.Topology, data.ActiveSite, data.MetalBindingSite, data.DNAFootprint, data.DNAFootprintBindingStrandedness,...
				data.DNAFootprintRegionStrandedness, data.MolecularInteraction, ...
            ...
            %proteinComplexs
            database.setNullValue(0);
            database.prepareStatement('select * from proteincomplexs');
            %database.prepareStatement('CALL get_proteincomplexs("{Si}",null)', this.wid);
            data = database.query();
            this.proteinComplexs = edu.jiangnan.fmme.cell.kb.ProteinComplex(...
                this, data.WID, data.WholeCellModelID, data.Name, ...
            ...
            %reactions
            database.setNullValue(0);
            database.prepareStatement('select * from reactions');
            %database.prepareStatement('CALL get_reactions("{Si}",null)', this.wid);
            data = database.query();
            this.reactions = edu.jiangnan.fmme.cell.kb.Reaction(...
            ...
            %pathways
            database.setNullValue(0);
            database.prepareStatement('select * from pathways');
            %database.prepareStatement('CALL get_pathways("{Si}",null)', this.wid);
            data = database.query();
            this.pathways = edu.jiangnan.fmme.cell.kb.Pathway(...
                this, data.WID, data.WholeCellModelID, data.Name);

            %stimuli
            database.setNullValue(0);
            database.prepareStatement('select * from stimulis');
            %database.prepareStatement('CALL get_stimulis("{Si}",null)', this.wid);
            data = database.query();
            this.stimulis = edu.jiangnan.fmme.cell.kb.Stimuli(...
                this, data.WID, data.WholeCellModelID, data.Name);

            %notes
            database.setNullValue(0);
            database.prepareStatement('select * from notes');
            %database.prepareStatement('CALL get_notes("{Si}",null)', this.wid);
            data = database.query();
            this.notes = edu.jiangnan.fmme.cell.kb.Note(...
                this, data.WID, data.WholeCellModelID, []);

            %references
            database.setNullValue(0);
            database.prepareStatement('select * from reference');
            %database.prepareStatement('CALL get_references("{Si}",null)', this.wid);
            data = database.query();
            this.references = edu.jiangnan.fmme.cell.kb.Reference(...
                this, data.WID, data.WholeCellModelID, [], ...
            ...
            this.linkObjects(database, 'process', 'parameter', struct(...
                'sqlProcedure', 'processs_parameters'));
           ...
           % end
			...
			this.linkObjects(database, 'gene', 'genome', struct(...
                'field1', 'genomes'));
            this.linkObjects(database, 'transcriptionUnit', 'genome', struct(...
                'field1', 'genomes'));
            this.linkObjects(database, 'genomeFeature', 'genome', struct(...
                'field1', 'genomes'));
			this.linkObjects(database, 'genomeFeature', 'gene', struct(...
                'field1', 'genes'));	
            this.linkObjects(database, 'genomeFeature', 'transcriptionUnit', struct(...
                'field1', 'transcriptionUnits'));
            ...
            this.linkObjects(database,'proteinMonomer','metabolite',struct(...
                'sqlProcedure','proteinmonomers_prostheticgroups',...
            ...
            this.linkObjects(database,'proteinComplex','metabolite',struct(...
                'sqlProcedure','proteincomplexs_prostheticgroups',...
                'field1', 'prostheticGroups', ...
                'field2', '',...
                'compartmentName', 'MetaboliteCompartmentIdx',...
                'compartmentField1', 'prostheticGroupCompartments',...
            ...
            this.linkObjects(database,'proteinMonomer','proteinMonomer',struct(...
                'sqlProcedure','proteinmonomers_proteinmonomerchaperones',...
            ...
            this.linkObjects(database,'proteinMonomer','proteinComplex',struct(...
                'sqlProcedure','proteinmonomers_proteincomplexchaperones',...
            ...
            this.linkObjects(database,'reaction','metabolite',struct(...
                'sqlProcedure','reactions_coenzymes',...
                'field1','coenzymes',...
            ...
            this.linkObjects(database,'reaction','gene',struct(...
                'sqlProcedure','reactions_stablernamodifications',...
            ...
            this.linkObjects(database,'reaction','proteinMonomer',struct(...
                'sqlProcedure','reactions_stableproteinmonomermodifications',...
                'field1','stableModifications',...
                'field2','stableModificationReactions',...
            ...
            %tRNA aminoacylation (finished)
            this.linkObjects(database,'gene','metabolite',struct(...
                'sqlProcedure','genes_aminoacids',...
                'field1','aminoAcid',...
                'field2',''));

            %transcription unit composition (finished)
            ...
            this.linkObjects(database,'metabolite','proteinComplex',struct(...  
                'sqlProcedure','metabolites_proteincomplexs',...
                'name1','MetaboliteIdx',...
            ...
            this.linkObjects(database,'gene','proteinComplex',struct(...
                'sqlProcedure','rnasubunits_proteincomplexs',...
                'name1','RNASubunitIdx',...
                'name2','ProteinComplexIdx',...
                'field1','',...
                'field2','rnas',...
            ...
            this.linkObjects(database,'proteinMonomer','proteinComplex',struct(...
                'sqlProcedure','proteinmonomersubunits_proteincomplexs',...
                'weightName','Coefficient',...
                'weightField1','',...
            ...
            this.linkObjects(database,'proteinComplex','proteinComplex',struct(...
                'sqlProcedure','proteincomplexsubunits_proteincomplexs',...
            ...
            this.linkObjects(database,'stimuli','reaction',struct(...
                'sqlProcedure','stimulireactantproducts_reactions',...
                'name1','StimulusIdx',...
                'name2','ReactionIdx',...
                'field1','',...
                'field2','stimulis',...
            ...
            this.linkObjects(database,'metabolite','reaction',struct(...
                'sqlProcedure','metabolitereactantproducts_reactions',...
                'weightName','Coefficient',...
                'weightField1','',...
                'weightField2','metaboliteCoefficients',...
                'compartmentName','MetaboliteCompartmentIdx',...
            ...
            this.linkObjects(database,'transcriptionUnit','reaction',struct(...
                'sqlProcedure','transcriptionunitreactantproducts_reactions',...
                ...
                'compartmentField2','rnaCompartments'));
            this.linkObjects(database,'proteinMonomer','reaction',struct(...
                'sqlProcedure','proteinmonomerreactantproducts_reactions',...
                'name1','MonomerIdx',...
                'name2','ReactionIdx',...
                'field1','',...
                'field2','proteinMonomers',...
                ...
                'compartmentField2','proteinMonomerCompartments'));
            this.linkObjects(database,'proteinComplex','reaction',struct(...
                'sqlProcedure','proteincomplexreactantproducts_reactions',...
                'name1','ComplexIdx',...
                'name2','ReactionIdx',...
                'field1','',...
                'field2','proteinComplexs',...
            ...
            this.linkObjects(database,'transcriptionUnit','proteinMonomer',struct(...
                'sqlProcedure','transcriptionunits_transcriptionfactorproteinmonomers',...
            ...
            this.linkObjects(database,'transcriptionUnit','proteinComplex',struct(...
                'sqlProcedure','transcriptionunits_transcriptionfactorproteincomplexs',...
            ...
            this.linkObjects(database,'proteinMonomer','stimuli',struct(...
                'sqlProcedure','proteinactivations_proteinmonomers_stimulis',...
            ...
            this.linkObjects(database,'proteinComplex','stimuli',struct(...
                'sqlProcedure','proteinactivations_proteincomplexs_stimulis',...
                'name2','StimulusRegulatorIdx',...
                'field1','stimuliRegulators',...
                'field2','regulatedProteinComplexs'));

            this.linkObjects(database,'proteinMonomer','metabolite',struct(...
                'sqlProcedure','proteinactivations_proteinmonomers_metabolites',...
                'name2','MetaboliteRegulatorIdx',...
                'field1','metaboliteRegulators',...
                'field2','regulatedProteinMonomers'));
            this.linkObjects(database,'proteinComplex','metabolite',struct(...
                'sqlProcedure','proteinactivations_proteincomplexs_metabolites',...
                'name2','MetaboliteRegulatorIdx',...
                'field1','metaboliteRegulators',...
                'field2','regulatedProteinComplexs'));

            this.linkObjects(database,'proteinMonomer','proteinMonomer',struct(...
                'sqlProcedure','proteinactivations_proteinmonomers_proteinmonomers',...
                'name2','ProteinMonomerRegulatorIdx',...
                'field1','proteinMonomerRegulators',...
                'field2','regulatedProteinMonomers'));
            this.linkObjects(database,'proteinComplex','proteinMonomer',struct(...
                'sqlProcedure','proteinactivations_proteincomplexs_proteinmonomers',...
                'name2','ProteinMonomerRegulatorIdx',...
                'field1','proteinMonomerRegulators',...
                'field2','regulatedProteinComplexs'));

            this.linkObjects(database,'proteinMonomer','proteinComplex',struct(...
                'sqlProcedure','proteinactivations_proteinmonomers_proteincomplexs',...
                'name2','ProteinComplexRegulatorIdx',...
                'field1','proteinComplexRegulators',...
                'field2','regulatedProteinMonomers'));
            this.linkObjects(database,'proteinComplex','proteinComplex',struct(...
                'sqlProcedure','proteinactivations_proteincomplexs_proteincomplexs',...
                'name2','ProteinComplexRegulatorIdx',...
                'field1','proteinComplexRegulators',...
                'field2','regulatedProteinComplexs'));
            ...
            this.linkObjects(database,'metabolite','compartment',struct(...
                'sqlProcedure','metabolites_biomasscompositions',...
            ...
            %media composition
            this.linkObjects(database,'metabolite','compartment',struct(...
                'sqlProcedure','metabolites_mediacomponents',...
            ...
            this.linkObjects(database,'process','reference', struct(...
                'sqlProcedure','processs_references'));
            ...
            this.linkObjects(database,'genome','reference');
        ...
        function linkObjects(this, database, objectName1, objectName2, options)
           ...
           if isfield(options, 'sqlProcedure')
                sql2= options.sqlProcedure;
                sqlProcedure=[sql1 sql2];
                prepareStatement(database,sqlProcedure,options.sqlProcedure)
           else
            sql2=[objectName1 '_' objectName2];
            sqlProcedure=[sql1 sql2];
            prepareStatement(database,sqlProcedure,objectName1, objectName2)
            end
               %get_proteinactivations_proteinmonomers_proteinmonomers
               %this.linkObjects(database,'metabolite','compartment',struct('sqlProcedure','get_metabolites_mediacomponents'
               
                %sqlProcedure = regexp(sql, '"{(S|Sn|Si|M|B|F|uF)}"', objectName1, objectName2);
                %sqlProcedure = sprintf('get_%s_%s', objectName1, objectName2);
            

            database.setNullValue(nanValue);
            
            %database.prepareStatement(sqlProcedure);
    ...
    methods
        ...
        function invalidate(this)
            this.invalidate@edu.jiangnan.fmme.cell.kb.KnowledgeBaseObject();
        ...
        function calcIndices(this)
            this.calcIndices@edu.jiangnan.fmme.cell.kb.KnowledgeBaseObject();
        ...
        function computeDependentProperties(this)            
            ...
            this.numGenomes            = numel(this.genomes);
			...
			[~,this.mitochondriaCompartmentIndexs]              = ismember(this.mitochondriaCompartmentWholeCellModelIDs, wholeCellModelIDs);
            ...
            %[~, this.modifiedNMPIndexs]             = ismember({'PSIURIMP';'M5CMP';'M62AMP';'M2GMP';'M7GMP';'GmMP';'UmMP';'s2UMP';'M1GMP';'k2CMP';'s4UMP';'cmnm5s2UMP';'m6AMP'}, wholeCellModelIDs);
            [~, this.modifiedNMPIndexs]             = ismember({'M1GMP';'2DUMP';'M22GMP';'INS';'N1GMP';'PSIURIMP';'M5UMP';'M2GMP';'M5CMP';'M1AMP';...
			'T6AMP';'MCM5UMP';'I6AMP';'M7GMP';'MCM5S2UMP';'CMCMP';'AMAMP';'GMGMP';'AC4CMP';'CMGMP';'YWGMP';'UMUMP';'M3CMP';'M3UMP'}, wholeCellModelIDs);
            [~, this.aminoAcidIndexs]               = ismember({'ALA_L'; 'ARG_L'; 'ASN_L'; 'ASP_L'; 'CYS_L'; 'GLN_L'; 'GLU_L'; 'GLY_L'; 'HIS_L'; ...
			'ILE_L'; 'LEU_L'; 'LYS_L'; 'MET_L'; 'PHE_L'; 'PRO_L'; 'SER_L'; 'THR_L'; 'TRP_L'; 'TYR_L'; 'VAL_L'}, wholeCellModelIDs);
            [~, this.cysteineIndexs]                = ismember({'CYS_L'}, wholeCellModelIDs);
            [~, this.methionineIndexs]              = ismember({'MET_L'}, wholeCellModelIDs);
            %[~, this.fmethionineIndexs]            = ismember({'FMET'}, wholeCellModelIDs);
            [~, this.modifiedAminoAcidIndexs]       = ismember({'DIACYLGLYCEROLCYS';'LIPOYLLYS'; 'PSER'; 'PTHR'; 'PTYR'; 'ACLYS'; 'ACSER'; 'ACMET'; 'ACALA'; 'ACTHR'; 'PAMTCYS'}, wholeCellModelIDs);
            ...
            [~,this.ribosomalRRNAIndexs] = ismember({'5S_RRNA_1'; '5_8S_RRNA_1'; '18S_RRNA_1'; '25S_RRNA_1'}, names);
        ...
        function delete(this)
            ...
            %(MATLAB seems to have difficulty clearing objects when these
            %links are present. By manually removing the links, we improve
            %the run time of deleting instances of this object to 10-15s)
            this.serializeLinks();

            %super class delete method
            this.delete@edu.jiangnan.fmme.cell.kb.KnowledgeBaseObject();
        end
        ...
        function serializeLinks(this)
            ...
            %serializeLinks@edu.jiangnan.fmme.cell.kb.KnowledgeBaseObject(this);
        end
        ...
        function deserializeLinks(this)
            ...
            this.genomes.deserializeLinks(this);
            ...
            this.knowledgeBase = this;
            %deserializeLinks@edu.jiangnan.fmme.cell.kb.KnowledgeBaseObject(this);
        end
    end
end