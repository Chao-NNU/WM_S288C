...
classdef Enzyme < edu.jiangnan.fmme.cell.kb.KnowledgeBaseObject
    properties
    ...
    methods
        function this = Enzyme(knowledgeBase, wid, wholeCellModelID, name,...
            ...
            this = edu.jiangnan.fmme.cell.kb.Enzyme.empty(size(wid, 1), 0);
            this(size(wid, 1), 1) = edu.jiangnan.fmme.cell.kb.Enzyme;
            for i = 1:size(wid, 1)
                this(i,1).idx = i;
