...
classdef dsDNA < edu.jiangnan.fmme.cell.kb.NucleicAcid
    ...
    methods
        function this = dsDNA(knowledgeBase, wid, wholeCellModelID, name, ...
            ...
            this = edu.jiangnan.fmme.cell.kb.dsDNA.empty(size(wid,1),0);
            this(size(wid,1),1) = edu.jiangnan.fmme.cell.kb.dsDNA;
            for i = 1:size(wid,1)
                this(i,1).idx = i;
        ...
        function value = get.volume(this)
            ...
            %calculate
            value = pi * (12e-7)^2 * 0.34e-7 * this.sequenceLength*edu.jiangnan.fmme.util.ConstantUtil.nAvogadro;
