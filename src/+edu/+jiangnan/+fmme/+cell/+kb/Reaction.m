...
classdef Reaction < edu.jiangnan.fmme.cell.kb.KnowledgeBaseObject
    properties
        ...
        stimuliCompartments                = edu.jiangnan.fmme.cell.kb.Compartment.empty(0,0);
        stimuliCoefficients                = [];
        ...
        rnas                               = edu.jiangnan.fmme.cell.kb.TranscriptionUnit.empty(0,0);
        ...
        enzymes                            = edu.jiangnan.fmme.cell.kb.Enzyme.empty(0,0);
        enzymeCompartments                 = edu.jiangnan.fmme.cell.kb.Compartment.empty(0,0);

        coenzymes                          = edu.jiangnan.fmme.cell.kb.Metabolite.empty(0,0);
        coenzymeCompartments               = edu.jiangnan.fmme.cell.kb.Compartment.empty(0,0);
        coenzymeCoefficients               = [];

        stableModifications                = [];
        stableModificationCompartments     = edu.jiangnan.fmme.cell.kb.Compartment.empty(0,0);
    ...
    methods
        function this = Reaction(knowledgeBase, wid, wholeCellModelID, name, ...
            ...
            this = edu.jiangnan.fmme.cell.kb.Reaction.empty(size(wid,1),0);
            this(size(wid,1),1) = edu.jiangnan.fmme.cell.kb.Reaction;
            for i=1:size(wid,1)
                this(i,1).idx = i;
