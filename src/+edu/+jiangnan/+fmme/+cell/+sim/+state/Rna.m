...
classdef Rna < edu.jiangnan.fmme.cell.sim.MoleculeCountState
    properties (Constant)
        ...
        fixedConstantNames      = {   %names of process properties that are considered fixed constants
            ...
            'weightFractionRRNA5_8S'
            'weightFractionRRNA18S'
            'weightFractionRRNA25S'          
            'weightFractionTRNA'
            'weightFractionSRNA'
    ...
    properties (Constant)
        ...
        rRNAWeightFractionIndexs    = (2:5)';
        sRNAWeightFractionIndexs    = 6;
        tRNAWeightFractionIndexs    = 7;
        rRNA5SWeightFractionIndexs  = 2;
        rRNA5_8SWeightFractionIndexs  = 3;
        rRNA18SWeightFractionIndexs = 4;
        rRNA25SWeightFractionIndexs = 5;
    end
    ...
    properties
        ...
        weightFractionRRNA5_8S      %5_8S rRNA fraction of RNAs, by weight
        weightFractionRRNA18S       %18S rRNA fraction of RNAs, by weight
        weightFractionRRNA25S       %25S rRNA fraction of RNAs, by weight
    ...
    methods
        function initializeConstants(this, knowledgeBase, simulation)
            ...
            this.matureIndexs        = (1:numel(matureRNAs.wholeCellModelIDs))'        + this.processedIndexs(end);
			...
			%this.halfLives = [knowledgeBase.genes.halfLife]'; 
    ...
    methods
        function notUpdatedRnas = updateExternalState(this, deltaRnas, rnaIsDegraded) %#ok<INUSD>
			...
			if any(deltaMatureRnas(this.matureMRNAIndexs))  < 0
    ...
    methods
        ...
        function value = get.expectedWeightFractions(this)
            value = [
				...
				this.weightFractionRRNA5_8S
                this.weightFractionRRNA18S
                this.weightFractionRRNA25S
