...
classdef Metabolite < edu.jiangnan.fmme.cell.sim.MoleculeCountState
    %Constants
    properties (Constant)
    ...
    methods
        function initializeConstants(this, knowledgeBase, simulation)
            ...
            this.aminoAcidIndexs      = this.getIndexs({'ALA_L'; 'ARG_L'; 'ASN_L'; 'ASP_L'; 'CYS_L'; 'GLN_L'; 'GLU_L'; 'GLY_L'; 'HIS_L'; 'ILE_L'; 'LEU_L'; 'LYS_L'; 'MET_L'; 'PHE_L'; 'PRO_L'; 'SER_L'; 'THR_L'; 'TRP_L'; 'TYR_L'; 'VAL_L'});                                                           
            ...
            this.unmodifiedBaseIndexs = this.getIndexs({'ADE'; 'CSN'; 'GUA'; 'THY'});
            ...
            this.setCounts(:, Condition.valueIndexs) = round(...
                ...
                edu.jiangnan.fmme.util.ConstantUtil.nAvogadro / 1000 * simulation.state('Geometry').chamberVolume);
        ...
        function allocateMemory(this, numTimePoints)
            ...
            this.allocateMemory@edu.jiangnan.fmme.cell.sim.MoleculeCountState(numTimePoints);
    ...
    methods
        ...
        function value = calcDryWeight(this)
            ...
            value = ...
                + value / edu.jiangnan.fmme.util.ConstantUtil.nAvogadro ...
                - this.wetWeight;
        end
        
        function value = get.wetWeight(this)
            value = this.counts(this.waterIndexs, :, :) * this.molecularWeights(this.waterIndexs) / edu.jiangnan.fmme.util.ConstantUtil.nAvogadro;
        end
    end
end
