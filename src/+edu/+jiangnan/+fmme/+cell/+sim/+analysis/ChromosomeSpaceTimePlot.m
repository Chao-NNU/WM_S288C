...
classdef ChromosomeSpaceTimePlot
    ...
    methods (Static = true);
        function run(relSimPath, selectedTime, fileName)
            ...
            import edu.jiangnan.fmme.cell.sim.analysis.ChromosomeSpaceTimePlot;
            ...
            [ax1, figHandle1] = edu.jiangnan.fmme.cell.sim.util.PlotUtil.newAxesHandle();
            ...
            [ax3, figHandle3] = edu.jiangnan.fmme.cell.sim.util.PlotUtil.newAxesHandle();
            ...
            [ax4, figHandle4] = edu.jiangnan.fmme.cell.sim.util.PlotUtil.newAxesHandle();
        ...
        function plotSpaceTimeDensity(axesHandle, densityMatrix, maxTime, pxWidth, figTitle)
            ...
            colormap(axesHandle, edu.jiangnan.fmme.cell.sim.analysis.ChromosomeSpaceTimePlot.cmap);
        ...
        function plotCircularDensity(axesHandle, densityBEMatrix, maxTime, simulation, indepRingNormalize, figTitle)
            ...
            set(h, 'ButtonDownFcn', 'edu.jiangnan.fmme.cell.sim.analysis.ChromosomeSpaceTimePlot.getClickPos(maxSpace)');
            ylbl = get(c_handle, 'YLabel');
        ...
        function RNAPSparseMat = makeRNAPSparseMat(states, sim)
            ...
            RNAPSparseMat = edu.jiangnan.fmme.util.CircularSparseMat(posStrndTimes, polStates, [c.sequenceLen 4 nTimePoints], 1);
        end
