...
classdef RNAExpression
    methods (Static = true)
        function run(sim, fileName)
            ...
            exp_mRNAWt = 0.041;
            exp_rRNAWt = [0.017; 0.271; 0.425; 0.1];
            exp_sRNAWt = 0;
            exp_tRNAWt = 0.146;
            ...
            h = [
                ...
                plot(axesHandle, RNAwt(2:5), exp_RNAWt(2:5), 'g.')
                plot(axesHandle, RNAwt(6), exp_RNAWt(6), 'b.')
                plot(axesHandle, RNAwt(7), exp_RNAWt(7), 'c.')
                ];            
            ...
            saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-EarlyVsLaterPhaseReconstruction-WeightFractions.pdf']);
			saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-EarlyVsLaterPhaseReconstruction-WeightFractions.fig']);
            close(figHandle);
            ...
            saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-EarlyVsLaterPhaseReconstruction.pdf']);
			saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-EarlyVsLaterPhaseReconstruction.fig']);
            close(figHandle);
