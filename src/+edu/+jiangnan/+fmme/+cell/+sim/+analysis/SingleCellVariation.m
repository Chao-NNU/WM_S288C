...
classdef SingleCellVariation
    methods (Static)
        function run(sim, fileName)
            import edu.jiangnan.fmme.cell.sim.analysis.SingleCellVariation;
            ...
            if nargin == 1
                ...
                saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-GrowthRate.pdf']);
				saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-GrowthRate.fig']);
                
                cla(axesHandle);
                SingleCellVariation.plotSingleCellVariationDoublingTimeDistribution(sim, growthRates, axesHandle);
                saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-DoublingTime.pdf']);
                saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-DoublingTime.fig']);
				
                cla(axesHandle);
                SingleCellVariation.plotExpected_Vs_Simulated_RNA_Weight_Fractions(sim, axesHandle);
                saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_RNA_Weight_Fractions.pdf']);
				saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_RNA_Weight_Fractions.fig']);
                
                cla(axesHandle);
                SingleCellVariation.plotExpected_Vs_Simulated_RNA_Expression(sim, axesHandle);
                saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_RNA_Expression.pdf']);
				saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_RNA_Expression.fig']);
                
                cla(axesHandle);
                SingleCellVariation.plotExpected_Vs_Simulated_rRNAExpression(sim, axesHandle);
                saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_rRNA_Expression.pdf']);
				saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_rRNA_Expression.fig']);
                
                cla(axesHandle);
                SingleCellVariation.plotExpected_Vs_Simulated_sRNA_Expression(sim, axesHandle);
                saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_sRNA_Expression.pdf']);
				saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_sRNA_Expression.fig']);
                
                cla(axesHandle);
                SingleCellVariation.plotExpected_Vs_Simulated_tRNA_Expression(sim, axesHandle);
                saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_tRNA_Expression.pdf']);
				saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_tRNA_Expression.fig']);
                
                cla(axesHandle);
                SingleCellVariation.plotExpected_Vs_Simulated_Monomer_Expression(sim, axesHandle);
                saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_Monomer_Expression.pdf']);
				saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_Monomer_Expression.fig']);
                
                cla(axesHandle);
                SingleCellVariation.plotExpected_Vs_Simulated_NTP_Incorporation(sim, axesHandle);
                saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_NTP_Incorporation.pdf']);
				saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_NTP_Incorporation.fig']);
                
                cla(axesHandle);
                SingleCellVariation.plotExpected_Vs_Simulated_AA_Incorporation(sim, axesHandle);
                saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_AA_Incorporation.pdf']);
				saveas(figHandle, ['/home/fmme/GSMM/wholecelldata/s288c/tmp/', fileName '-Expected_Vs_Simulated_AA_Incorporation.fig']);
    ...
    methods (Static = true)
        ...
        function plotExpected_Vs_Simulated_RNA_Weight_Fractions(sim, axesHandle)
            import edu.jiangnan.fmme.cell.sim.analysis.Constants;
            import edu.jiangnan.fmme.util.ConstantUtil;
