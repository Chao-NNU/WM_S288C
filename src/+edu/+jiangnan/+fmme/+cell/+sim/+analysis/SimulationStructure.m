...
classdef SimulationStructure
    methods (Static = true)        
        function run(sim, fileName)
            import edu.jiangnan.fmme.cell.sim.analysis.SimulationStructure;
    ...
    methods (Static)
        ...
        function [content, colLabels] = unincludedMetabolites(sim)
            ...
            included = edu.jiangnan.fmme.cell.sim.analysis.SimulationStructure.processMetabolites(sim);
        ...
        function [content, colLabels] = unincludedGenes(sim)
            ...
            included = edu.jiangnan.fmme.cell.sim.analysis.SimulationStructure.processGeneProducts(sim);
