...
classdef Process < handle
    ...
    methods
        ...
        function value = getDryWeight(this)
            ...
            value = value / edu.jiangnan.fmme.util.ConstantUtil.nAvogadro;
        end
    end
    ...
    methods (Access = protected)
        ...
        function [...
			...
			metaboliteCompartments(this.metabolite.hydrophobicIndexs) = this.compartment.mitochondriaIndexs;
    ...
    methods
        ...
        function lclState = copyFromStateHelper(~, gblState, gblIdxs, cmpIdxs)
            ...
            if ~isa(gblState, 'edu.jiangnan.fmme.util.SparseMat');
            ...
            switch scale
                case 'mM'
                    scaledValues = unscaledValues / ...
                        (edu.jiangnan.fmme.util.ConstantUtil.nAvogadro/1000) / ...
