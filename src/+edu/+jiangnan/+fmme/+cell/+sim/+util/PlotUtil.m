    ...
    methods (Static = true)
        ...
        function labelCompartmentPlot(sim, plotHandles, compartments, varargin)
            ...
            if nargin == 4 && length(plotHandles) == length(varargin{1})
                ...
                compartmentLabels = edu.jiangnan.fmme.cell.sim.util.PlotUtil.compartmentPlotLabels(sim, compartments, varargin{:});
...
%             end
        ...
        function handle = plotNormalizedStackedArea(axesHandle, xdata, ydata, varargin)
            ...
            ydata(isnan(ydata)) = 0;
            handle = edu.jiangnan.fmme.cell.sim.util.PlotUtil.plotStackedArea(axesHandle, xdata, ydata, varargin{:});
        end
        ...
        function handle = plotXAxis(axesHandle, x, xLabel)
            handle = edu.jiangnan.fmme.cell.sim.util.PlotUtil.plotLine(axesHandle, x, ones(1,length(x)));
