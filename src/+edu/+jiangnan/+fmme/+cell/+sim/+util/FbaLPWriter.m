...
classdef FbaLPWriter
    methods (Static)
        function write(sim, dirName)
            import edu.jiangnan.fmme.cell.sim.util.FbaLPWriter;
        ...
        function write_lindo(sim, fileName, units)
            ...
            [compartmentIDs, compartmentNames, substrateIDs, ~, substrateNames, reactionIDs, ~, reactionNames] = ...
                edu.jiangnan.fmme.cell.sim.util.FbaLPWriter.calcIDs(sim);
            ...
            %header
            str = [str sprintf('! Autogenerated %s by edu.jiangnan.fmme.cell.sim.util.FbaLPWriter\n', datestr(now, 31))];
        ...
        function write_fba3_deletion(sim, fileName)
            [~, ~, ~, ~, ~, ~, reactionIDs] = edu.jiangnan.fmme.cell.sim.util.FbaLPWriter.calcIDs(sim);
