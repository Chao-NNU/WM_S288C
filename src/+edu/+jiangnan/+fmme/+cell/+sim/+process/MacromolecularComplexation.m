...
classdef  MacromolecularComplexation < edu.jiangnan.fmme.cell.sim.Process
    ...
    methods
        ...
        function initializeConstants(this, knowledgeBase, simulation, varargin)
		   ...
		   this.initializeComplexNetworks();
            ...
            this.initializeConstants@edu.jiangnan.fmme.cell.sim.Process(knowledgeBase, simulation);
        end
        ...
        function value = getDryWeight(this)
            if size(this.complexs, 3) == 1
                ...
                value = this.getDryWeight@edu.jiangnan.fmme.cell.sim.Process() + ...
                    ...
                    [1 3 2]) / edu.jiangnan.fmme.util.ConstantUtil.nAvogadro;
            end
        end
    end
end
