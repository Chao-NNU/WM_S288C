...
classdef RibosomeAssembly < edu.jiangnan.fmme.cell.sim.Process
    ...
    properties
		...
		%}
		enzymeWholeCellModelIDs = {    %whole cell model IDs of enzymes
            'YER155C_MONOMER';          %GTPase BEM2
            'YJR072C_MONOMER';          %GTPase NPA3
            'YOR262W_MONOMER';          %GTPase GPN2
            'YLR243W_MONOMER'};         %GTPase GPN3
	    enzymeIndexs_BEM2 = 1;         %index within enzymes of BEM2
        enzymeIndexs_NPA3 = 2;         %index within enzymes of NPA3
        enzymeIndexs_GPN2 = 3;         %index within enzymes of GPN2
        enzymeIndexs_GPN3 = 4;         %index within enzymes of GPN3	
        enzymeIndexs_40S_assembly_gtpase = [1;2]; %index within enzymes of 40 S ribosome assembly GTPases
        enzymeIndexs_60S_assembly_gtpase = [3;4]; %index within enzymes of 60 S ribosome assembly GTPases	
        ...
        complexWholeCellModelIDs = {   %whole cell model IDs of ribosomal particles
            'RIBOSOME_40S';            %30S ribosomal particle
            'RIBOSOME_60S'};           %50S ribosomal particle
        complexIndexs_40S_ribosome = 1;%index within complexs of 30S ribosomal particle
        complexIndexs_60S_ribosome = 2;%index within complexs of 50S ribosomal particle
    ...
    methods
        ...
        function initializeConstants(this, knowledgeBase, simulation, varargin)
            ...
            this.complexationCatalysisMatrix(this.enzymeIndexs_40S_assembly_gtpase, this.complexIndexs_40S_ribosome) = true;
            this.complexationCatalysisMatrix(this.enzymeIndexs_60S_assembly_gtpase, this.complexIndexs_60S_ribosome) = true;
        end
    ...
    methods
        ...
        function [bmProd, byProd, minEnzExp, maxEnzExp] = calcResourceRequirements_LifeCycle(this, ~, states)
            ...
            %% enzymes
            minEnzExp([
                this.enzymeIndexs_40S_assembly_gtpase;
                this.enzymeIndexs_60S_assembly_gtpase]) = 2;
        end
    ...
    methods
        function result = getDryWeight(this)
            rnaMolecularWeights = this.rna.molecularWeights(...
                this.rna.matureIndexs(this.rna.matureRRNAIndexs(this.rnaGlobalIndexs))) / edu.jiangnan.fmme.util.ConstantUtil.nAvogadro;
            monomerMolecularWeights = this.monomer.molecularWeights(...
                this.monomer.matureIndexs(this.monomerGlobalIndexs)) / edu.jiangnan.fmme.util.ConstantUtil.nAvogadro;
            complexMolecularWeights = this.complex.molecularWeights(...
                this.complex.nascentIndexs(this.complexGlobalIndexs)) / edu.jiangnan.fmme.util.ConstantUtil.nAvogadro;
            
            if size(this.RNAs, 3) == 1
                result = this.getDryWeight@edu.jiangnan.fmme.cell.sim.Process() + ...
