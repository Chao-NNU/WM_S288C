...
classdef ProteinDecay < edu.jiangnan.fmme.cell.sim.Process
    ...
    properties
		...
		'YLL039C_MONOMER';	%Ubiquitin
		'YKL210W_MONOMER';	%ubiquitin-activating enzyme E1
		'YGL058W_MONOMER';	%Ubiquitin-conjugating enzyme E2 A [2.3.2.23]
		'YOR339C_MONOMER';	%Ubiquitin-conjugating enzyme E2 C [2.3.2.23]
		'YOR059C_MONOMER';	%Ubiquitin-conjugating enzyme E2 D [2.3.2.23]
		'YBR082C_MONOMER';	%Ubiquitin-conjugating enzyme E2 D [2.3.2.23]
		'YMR022W_MONOMER';	%Ubiquitin-conjugating enzyme E2 G2 [2.3.2.23]
		'YEL012W_MONOMER';	%Ubiquitin-conjugating enzyme E2 H [2.3.2.23]
		'YER100W_MONOMER';	%Ubiquitin-conjugating enzyme E2 J2 [2.3.2.23]
		'YDR092W_MONOMER';	%Ubiquitin-conjugating enzyme E2 N [2.3.2.23]
		'YDR054C_MONOMER';	%Ubiquitin-conjugating enzyme E2 R [2.3.2.23]
		'YDR177W_MONOMER';	%Ubiquitin-conjugating enzyme [2.3.2.23]
		'YGR133W_MONOMER';	%Peroxin-4 [2.3.2.23]
		'YOL013C_YLR207W_YML029W_YBR201W_YDR507W_YJL034W_6MER';	%Hrd1 Complex, E3
		'YIL030C_YER100W_DIMER';	%Doa10 Complex, E3
		'YMR022W_MONOMER';	%Soluble E2 conjugating enzyme
		'YMR264W_MONOMER';	%Recruits Ubc7 and stimulates its activity
		'YDL126C_MONOMER';	%AAA ATPase, promotes substrate extraction from the ER and IN membranes
		'YML013W_MONOMER';	%Recruits Cdc48 to the ER and IN membranes
		'YGR048W_MONOMER';	%Cdc48 co-factor, required for ERAD
		'YBR170C_MONOMER';	%Cdc48 co-factor, required for ERAD
		'YJR099W_MONOMER';	%ubiquitin carboxyl-terminal hydrolase L3 
		'YJL197W_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 4/11
		'YMR304W_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 7
		'YDR069C_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 8
		'YER144C_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 8
		'YER151C_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 10
		'YFR010W_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 14
		'YMR223W_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 22/27/51
		'YOR124C_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 25
		'YDL122W_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 1
		'YKR098C_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 7/11
		'YIL156W_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 7/11
		'YER098W_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 9/13
		'YBL067C_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 9/13	
		'YNL186W_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 10
		'YPL072W_MONOMER';	%ubiquitin carboxyl-terminal hydrolase 16
		'YHL013C_MONOMER';	%OTU domain-containing protein 6 
		'YFR004W_MONOMER';	%26S proteasome regulatory subunit N11
		'YPL020C_MONOMER';	%ULPS - sentrin-specific protease 1
		'YIL031W_MONOMER';	%ULPS - sentrin-specific protease 7
		'YDL216C_MONOMER';	%COP9 signalosome complex subunit 5
		}
		
		enzymeIndexs_ubiquitin				 = 1;	%index within enzymes of ubiquitin
		enzymeIndexs_ubiquitin_enzyme_E1	 = 2;	%index within enzymes of ubiquitin-activating enzyme E1
		enzymeIndexs_ubiquitin_enzyme_E2_A	 = 3;	%index within enzymes of ubiquitin-conjugating enzyme E2 A
		enzymeIndexs_ubiquitin_enzyme_E2_C	 = 4;	%index within enzymes of ubiquitin-conjugating enzyme E2 C
		enzymeIndexs_ubiquitin_enzyme_E2_D1  = 5;	%index within enzymes of ubiquitin-conjugating enzyme E2 D1
		enzymeIndexs_ubiquitin_enzyme_E2_D2  = 6;	%index within enzymes of ubiquitin-conjugating enzyme E2 D2
		enzymeIndexs_ubiquitin_enzyme_E2_G2  = 7;	%index within enzymes of ubiquitin-conjugating enzyme E2 G2
		enzymeIndexs_ubiquitin_enzyme_E2_H   = 8;	%index within enzymes of ubiquitin-conjugating enzyme E2 H
		enzymeIndexs_ubiquitin_enzyme_E2_J2  = 9;	%index within enzymes of ubiquitin-conjugating enzyme E2 J2
		enzymeIndexs_ubiquitin_enzyme_E2_N   = 10;	%index within enzymes of ubiquitin-conjugating enzyme E2 N
		enzymeIndexs_ubiquitin_enzyme_E2_R   = 11;	%index within enzymes of ubiquitin-conjugating enzyme E2 R
		enzymeIndexs_ubiquitin_enzyme_Ubc1   = 12;	%index within enzymes of ubiquitin-conjugating enzyme Ubc1
		enzymeIndexs_ubiquitin_enzyme_Pex4   = 13;	%index within enzymes of ubiquitin-conjugating enzyme Peroxin-4
		enzymeIndexs_Hrd1_Complex			 = 14;	%index within enzymes of Hrd1 Complex, E3
		enzymeIndexs_Doa10_Complex			 = 15;	%index within enzymes of Doa10_Complex, E3
		enzymeIndexs_Ubc7					 = 16;	%index within enzymes of Soluble E2 conjugating enzyme
		enzymeIndexs_Cue1					 = 17;	%index within enzymes of Recruits Ubc7 and stimulates its activity	
		enzymeIndexs_Cdc48					 = 18;	%index within enzymes of AAA ATPase
		enzymeIndexs_Ubx2					 = 19;	%index within enzymes of Recruits Cdc48 to the ER and IN membranes
		enzymeIndexs_Ufd1					 = 20;	%index within enzymes of Cdc48 co-factor, required for ERAD
		enzymeIndexs_Npl4					 = 21;	%index within enzymes of Cdc48 co-factor, required for ERAD
		enzymeIndexs_Yuh1					 = 22;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase L3
		enzymeIndexs_Ubp12					 = 23;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 4/11
		enzymeIndexs_Ubp15					 = 24;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 7
		enzymeIndexs_Doa4					 = 25;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 8
		enzymeIndexs_Ubp5					 = 26;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 8
		enzymeIndexs_Ubp3					 = 27;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 10
		enzymeIndexs_Ubp6					 = 28;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 14
		enzymeIndexs_Ubp8					 = 29;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 22/27/51
		enzymeIndexs_Ubp2					 = 30;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 25
		enzymeIndexs_Ubp1					 = 31;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 1
		enzymeIndexs_Ubp11					 = 32;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 7/11
		enzymeIndexs_Ubp7					 = 33;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 7/11
		enzymeIndexs_Ubp9					 = 34;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 9/13
		enzymeIndexs_Ubp13					 = 35;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 9/13
		enzymeIndexs_Ubp10					 = 36;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 10
		enzymeIndexs_Ubp16					 = 37;	%index within enzymes of ubiquitin carboxyl-terminal hydrolase 16
		enzymeIndexs_Otu2					 = 38;	%index within enzymes of OTU domain-containing protein 6
		enzymeIndexs_Rpn11					 = 39;	%index within enzymes of 26S proteasome regulatory subunit N11
		enzymeIndexs_Ulp1					 = 40;	%index within enzymes of ULPS - sentrin-specific protease 1 
		enzymeIndexs_Ulp2					 = 41;	%index within enzymes of ULPS - sentrin-specific protease 7
		enzymeIndexs_Rri1					 = 42;	%index within enzymes of COP9 signalosome complex subunit 5
		enzymeIndexs_peptidases              = (22:42)'; %index within enzymes of peptidases	
    ...
    methods
        ...
        function [bmProd, byProd, minEnzExp, maxEnzExp] = calcResourceRequirements_LifeCycle(this, ~, states)
			...
			minEnzExp(this.enzymeIndexs_ubiquitin_enzyme_E2_A) = ...
			...
			minEnzExp(this.enzymeIndexs_ubiquitin_enzyme_E1) = 2;
            minEnzExp(this.enzymeIndexs_ubiquitin_enzyme_Ubc1) = 70; %to keep pace with degrading aborted polypeptides
        ...
        function result = calcResourceRequirements_Current(this)
			...
			nRefolding = (this.enzymes(this.enzymeIndexs_ubiquitin_enzyme_E1) > 0) * ( ...
			...
			if nRefolding > 0 && this.enzymes(this.enzymeIndexs_ubiquitin_enzyme_E1)
            ...
            result([this.substrateIndexs_atp; this.substrateIndexs_water]) = ...
                ...
                + all(this.enzymes(this.enzymeIndexs_peptidases)) * this.lonProteaseEnergyCost * min(...
                    this.enzymes(this.enzymeIndexs_ubiquitin_enzyme_E2_A) * this.lonProteaseSpecificRate, ...
            ...
            if ~isempty(this.polypeptide.abortedPolypeptides)
                result([this.substrateIndexs_atp; this.substrateIndexs_water]) = ...
                    ...
                    ceil(this.ftsHProteaseEnergyCost * min(...
                        ceil(this.enzymes(this.enzymeIndexs_ubiquitin_enzyme_Ubc1) * this.ftsHProteaseSpecificRate), ...
        ...
        function evolveState_RefoldProteins(this)
			...
			numFoldingProteins = (this.enzymes(this.enzymeIndexs_ubiquitin_enzyme_E1) > 0) * min([
        ...
        function evolveState_DegradeComplexes(this)
			...
			decayingModifiedRates = abs(decayingRates(this.complexIndexs_modified, :));
        ...
        function evolveState_DegradeAbortedPolypeptides(this)
            ...
            % import classes
            import edu.jiangnan.fmme.cell.kb.ProteinMonomer;
            ...
            if any(cleavages)
                ftsHCosts = this.randStream.stochasticRound((this.enzymes(this.enzymeIndexs_ubiquitin_enzyme_Ubc1) * this.stepSizeSec) ./ cumsum(cleavages / this.ftsHProteaseSpecificRate));
        ...
        function evolveState_DegradeMonomers(this)
            ...
            protease  = this.enzymes(this.enzymeIndexs_ubiquitin_enzyme_E2_A) * this.stepSizeSec * this.lonProteaseSpecificRate;
            ...
            while any(decayingProteins(:))
                ...
                idx = this.randStream.randsample(numel(decayingRates), 1, true, abs(decayingRates(:)));
