...
classdef  Metabolism < edu.jiangnan.fmme.cell.sim.ReactionProcess
    ...
    properties
		...
		compartmentIndexs_mitochondria		  %index of mitochondria compartment within reactionStoichiometryMatrix
    end
    ...
    methods
        function this = Metabolism(wholeCellModelID, name)
            this = this@edu.jiangnan.fmme.cell.sim.ReactionProcess('Process_Metabolism','Metabolism')%(wholeCellModelID, name);
        end
    end
    ...
    methods
        ...
        function storeObjectReferences(this, simulation)
            this.storeObjectReferences@edu.jiangnan.fmme.cell.sim.ReactionProcess(simulation);
        ...
        function initializeConstants(this, knowledgeBase, simulation, varargin)
            ...
            this.initializeConstants@edu.jiangnan.fmme.cell.sim.ReactionProcess(...
			...
			this.compartmentIndexs_mitochondria  = 3;
            
            compartmentIndexs = [
                this.compartment.cytosolIndexs;
				this.compartment.extracellularIndexs;
                this.compartment.mitochondriaIndexs];
        ...
        function [subCmpRemoved, rxnRemoved] = formulateFBA(this, metabolismProduction, unaccountedEnergyConsumption, simplifyNetwork)
            ...
            import edu.jiangnan.fmme.util.ConstantUtil;
            import edu.jiangnan.fmme.util.findNonInteractingRowsAndColumns;
			...
			this.metabolismNewProduction(this.substrateIndexs({'MET_L'; 'H'; 'H2O'}), this.compartmentIndexs_cytosol) = ...
                + this.metabolismNewProduction(this.substrateIndexs({'MET_L'; 'H'; 'H2O'}), this.compartmentIndexs_cytosol) ...
                + [1; 1; -1] .* this.metabolismRecyclingProduction(this.substrateIndexs({'FMET'}), this.compartmentIndexs_cytosol);
				
            this.metabolismRecyclingProduction(this.substrateIndexs({'MET_L'; 'H'; 'H2O'}), this.compartmentIndexs_cytosol) = ...
                + this.metabolismRecyclingProduction(this.substrateIndexs({'MET_L'; 'H'; 'H2O'}), this.compartmentIndexs_cytosol) ...
                - [1; 1; -1] .* this.metabolismRecyclingProduction(this.substrateIndexs({'FMET'}), this.compartmentIndexs_cytosol);

			tmp = ...
                + this.metabolismNewProduction(this.substrateIndexs({'10FTHF'; 'FOR'; 'TEHF'}), this.compartmentIndexs_cytosol) ...
                + this.metabolismRecyclingProduction(this.substrateIndexs({'10FTHF'; 'FOR'; 'TEHF'}), this.compartmentIndexs_cytosol);
			
            this.metabolismNewProduction(this.substrateIndexs({'10FTHF'; 'FOR'; 'TEHF'}), this.compartmentIndexs_cytosol) = max(0, ...
                + tmp ...
            ...
            subCmpIdxs_metaboliteInternalExchangeConstraints = sub2ind([nSubstrates nCompartments], ...
                subIdxs_metaboliteInternalExchangeConstraints, repmat(this.compartmentIndexs_cytosol, size(...
				subIdxs_metaboliteInternalExchangeConstraints)));
            ...
            [~, fthf10Idxs] = ismember(this.substrateIndexs({'10FTHF'; 'TEHF'; 'FOR'}), i);
            [~, metIdxs] = ismember(this.substrateIndexs({'MET_L'; 'FMET'}), i);
    ...
    methods
        ...
        function evolveState(this)
            ...
            if any(any(this.substrates(this.substrateMetaboliteLocalIndexs(:, 1), :) < -1))
				...
				compIDs(this.compartmentIndexs_mitochondria) = {'m'};
