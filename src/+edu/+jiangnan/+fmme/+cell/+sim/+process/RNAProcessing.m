...
%   experimentally determined genome organization of M. pnemoniae by G?ell et al
...
%   - All mRNAs G?ell Serrano et al did not assign to a suboperon because of
...
%   References
%   ==================
%   1. G?ell M, van Noort V, Yus E, Chen WH, Leigh-Bell J, Michalodimitrakis K,
%      Yamada T, Arumugam M, Doerks T, K?hner S, Rode M, Suyama M, Schmidt S,
...
%   5. Theissen B, Karow AR, K?hler J, Gubaev A, Klostermeier D (2008).
...
classdef RNAProcessing < edu.jiangnan.fmme.cell.sim.Process
    ...
    properties
        ...
        enzymeWholeCellModelIDs = {     %whole cell model IDs of enzymes
            'YMR239C_MONOMER';          %ribonuclease III
            'YNL221C_YNL282W_YBR257W_YAL033W_YGR030C_YBR167C_YBL018C_YIR015W_YHR062C_9MER';            		%ribonuclease P
			'YNL221C_YNL282W_YBR257W_YAL033W_YGR030C_YBR167C_YBL018C_YLR145W_YHR062C_YDR478W_10MER';		%ribonuclease MRP
            'YGL099W_MONOMER';          %ribosome small subunit-dependent GTPase A
			'YMR290C_MONOMER'};         %ATP-dependent RNA helicase
		...
		enzymeIndexs_RNAseMRP = 2;      %index within enzymes of ribonuclease J
		...
		enzymeIndexs_Lsg1     = 4;      %index within enzymes of ribosome small subunit-dependent GTPase A		
        %enzymeIndexs_DeaD     = 5;      %index within enzymes of ATP-dependent RNA helicase
		enzymeIndexs_Has1     = 5;      %index within enzymes of ATP-dependent RNA helicase
    ...
    properties
		...
		enzymeEnergyCost_Has1           % 2.37 ATP/reaction   (210 ATP/min B. subtilis [PUB_0069])/(1.48 rxn/s B. subtilis  [PUB_0688])
    ...
    methods
        function initializeConstants(this, knowledgeBase, simulation, varargin)
			...
			this.reactantByproductMatrix(this.substrateIndexs_H2O, :) = -(sum(this.rna.nascentRNAMatureRNAComposition, 1) - 1);
			...
			this.reactantByproductMatrix(this.substrateIndexs_H,   :) =  (sum(this.rna.nascentRNAMatureRNAComposition, 1) - 1);
			...
			%}
			energyIdxs_Has1 = [this.substrateIndexs_ATP; this.substrateIndexs_ADP; this.substrateIndexs_PI; this.substrateIndexs_H2O; this.substrateIndexs_H];
            this.reactantByproductMatrix(energyIdxs_Has1, this.unprocessedRNAIndexs_rRNA) = ...
                this.reactantByproductMatrix(energyIdxs_Has1, this.unprocessedRNAIndexs_rRNA) + ...
                round(this.enzymeEnergyCost_Lsg1) * repmat([-1; 1; 1; -1; 1], 1, numel(this.unprocessedRNAIndexs_rRNA));
				
            energyIdxs_Lsg1 = [this.substrateIndexs_GTP; this.substrateIndexs_GDP; this.substrateIndexs_PI; this.substrateIndexs_H2O; this.substrateIndexs_H];
            this.reactantByproductMatrix(energyIdxs_Lsg1, this.unprocessedRNAIndexs_rRNA) = ...
                this.reactantByproductMatrix(energyIdxs_Lsg1, this.unprocessedRNAIndexs_rRNA) + ...
                round(this.enzymeEnergyCost_Has1) * repmat([-1; 1; 1; -1; 1], 1, numel(this.unprocessedRNAIndexs_rRNA));
			...
			catalysis(this.enzymeIndexs_Has1,     this.unprocessedRNAIndexs_rRNA) = 1;
            %catalysis(this.enzymeIndexs_RNAseJ,   this.unprocessedRNAIndexs_rRNA) = 2;
			catalysis(this.enzymeIndexs_RNAseMRP,   this.unprocessedRNAIndexs_rRNA) = 2;
			...
			catalysis(this.enzymeIndexs_Lsg1,     this.unprocessedRNAIndexs_rRNA) = 1;
			...
			enzymeSpecificRates(this.enzymeIndexs_Has1)     = this.enzymeSpecificRate_Has1;
            %enzymeSpecificRates(this.enzymeIndexs_RsgA)     = this.enzymeSpecificRate_RsgA;
			enzymeSpecificRates(this.enzymeIndexs_Lsg1)     = this.enzymeSpecificRate_Lsg1;
			...
			enzymeSpecificRates(this.enzymeIndexs_RNAseMRP)   = this.enzymeSpecificRate_RNAseMRP;
