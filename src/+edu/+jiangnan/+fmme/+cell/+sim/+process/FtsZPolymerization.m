...
classdef FtsZPolymerization < edu.jiangnan.fmme.cell.sim.Process
    ...
    properties
        ...
        enzymeWholeCellModelIDs = {     %whole cell model IDs of enzymes
            'YDL126C_MONOMER';           %cell division protein FtsZ
            'YDL126C_MONOMER_GDP';       %cell division protein FtsZ deactivated
            'YDL126C_MONOMER_GTP';       %cell division protein FtsZ activated
            'YDL126C_2MER_GTP';          %cell division protein FtsZ activated 2mer
            'YDL126C_3MER_GTP';          %cell division protein FtsZ activated 3mer
            'YDL126C_4MER_GTP';          %cell division protein FtsZ activated 4mer
            'YDL126C_5MER_GTP';          %cell division protein FtsZ activated 5mer
            'YDL126C_6MER_GTP';          %cell division protein FtsZ activated 6mer
            'YDL126C_7MER_GTP';          %cell division protein FtsZ activated 7mer
            'YDL126C_8MER_GTP';          %cell division protein FtsZ activated 8mer
            'YDL126C_9MER_GTP'};         %cell division protein FtsZ activated 9mer
        enzymeIndexs_FtsZ           = 1;
    ...
    methods
        ...
        function [bmProd, byProd, minEnzExp, maxEnzExp] = calcResourceRequirements_LifeCycle(this, constants, states)
            import import edu.jiangnan.fmme.cell.sim.process.Cytokinesis;
            ...
            [~, gtpCost] = Cytokinesis.calcRequiredPinchingCycles(this.geometry.daughterwidth, ...
            ...
            gdpCost = ...
                ...
                - 9 * states.complexProductions(this.complex.getIndexs('YDL126C_9MER_GDP'));
    ...
    methods
        ...
        function [tout, yout] = integrateODEs(this, y0)
            ...
            threshold = 0.1 / edu.jiangnan.fmme.util.ConstantUtil.nAvogadro / this.geometry.volume;
            rtol = 1e-2;
        ...
        function result = moleculesToConcentration(this, count)
            N = edu.jiangnan.fmme.util.ConstantUtil.nAvogadro;
