...
classdef  ProteinModification < edu.jiangnan.fmme.cell.sim.ReactionProcess
    ...
    properties
        ...
        enzymeIndexs_serineThreonineKinase  	%index of serine/threonine kinase within enzymes
		
		enzymeIndexs_nterminalacetyltransferase %index of N-terminal acetyltransferase within enzymes
		enzymeIndexs_histoneacetyltransferase	%index of histone acetyltransferase within enzymes
    ...
    methods
        ...
        function initializeConstants(this, knowledgeBase, simulation, varargin)
			...
			this.enzymeIndexs_serineThreonineKinase         = this.enzymeIndexs({'YPL153C_MONOMER'; 'YBR136W_MONOMER'; ...
				          'YBL088C_MONOMER'; 'YDL108W_MONOMER'; 'YPR161C_MONOMER'; 'YMR139W_MONOMER'; 'YDL079C_MONOMER'; ...
						  'YDL028C_MONOMER'; 'YOL100W_MONOMER'; 'YDR490C_MONOMER'; 'YHR079C_MONOMER'; 'YMR001C_MONOMER'; ...
						  'YNL298W_MONOMER'; 'YFL029C_MONOMER'; 'YGL180W_MONOMER'; 'YOR351C_MONOMER'});
			this.enzymeIndexs_nterminalacetyltransferase    =	this.enzymeIndexs({'YHR013C_YDL040C_YOR253W_TRIMER'});
			this.enzymeIndexs_histoneacetyltransferase      =	this.enzymeIndexs({'YOR244W_MONOMER'; 'YGR252W_MONOMER'});			
