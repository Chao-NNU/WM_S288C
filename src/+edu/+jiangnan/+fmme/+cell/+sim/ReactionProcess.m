...
classdef ReactionProcess < edu.jiangnan.fmme.cell.sim.Process
    ...
    methods
        ...
        function initializeConstants(this, knowledgeBase, simulation, options)
            ...
            %super class method
            initializeConstants@edu.jiangnan.fmme.cell.sim.Process(this, knowledgeBase, simulation, options);
    ...
    methods
        ...
        function value = computeFixedConstantsNames(this)
            value = [this.computeFixedConstantsNames@edu.jiangnan.fmme.cell.sim.Process();
                'reactionNames';
                'reactionTypes';
    ...
    methods (Access = protected)
        ...
        function initializeConstants_overrideSubstrates(this, wholeCellModelIDs)           
            ...
            %super class method
            this.initializeConstants_overrideSubstrates@edu.jiangnan.fmme.cell.sim.Process(wholeCellModelIDs);
        end
        ...
        function initializeConstants_overrideEnzymes(this, wholeCellModelIDs)
            ...
            %super class method
            this.initializeConstants_overrideEnzymes@edu.jiangnan.fmme.cell.sim.Process(wholeCellModelIDs);
        end
    end
end