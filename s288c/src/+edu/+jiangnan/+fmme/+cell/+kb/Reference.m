...
classdef Reference < edu.jiangnan.fmme.cell.kb.KnowledgeBaseObject
    properties
        type
        pmid
        isbn
        ...
        transcriptionUnits = edu.jiangnan.fmme.cell.kb.ProteinComplex.empty(0,0);
        genomeFeatures     = edu.jiangnan.fmme.cell.kb.GenomeFeature.empty(0,0);
        proteinMonomers    = edu.jiangnan.fmme.cell.kb.TranscriptionUnit.empty(0,0);
        proteinComplexs    = edu.jiangnan.fmme.cell.kb.ProteinMonomer.empty(0,0);
    ...
    methods
        function this = Reference(knowledgeBase, wid, wholeCellModelID, name,...
            ...
            this = edu.jiangnan.fmme.cell.kb.Reference.empty(size(wid,1),0);
            this(size(wid,1),1) = edu.jiangnan.fmme.cell.kb.Reference;
            for i = 1:size(wid,1)
                this(i,1).idx = i;
