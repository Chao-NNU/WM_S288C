...
classdef ProteinComplex < edu.jiangnan.fmme.cell.kb.PhysicalObject & edu.jiangnan.fmme.cell.kb.Protein
    properties
        ...
        metaboliteCompartments      = edu.jiangnan.fmme.cell.kb.Compartment.empty(0, 0);
        metaboliteCoefficients      = [];

        rnas                        = edu.jiangnan.fmme.cell.kb.Gene.empty(0, 0);
        rnaCompartments             = edu.jiangnan.fmme.cell.kb.Compartment.empty(0, 0);
        rnaCoefficients             = [];

        proteinMonomers             = edu.jiangnan.fmme.cell.kb.ProteinMonomer.empty(0, 0);
        proteinMonomerCompartments  = edu.jiangnan.fmme.cell.kb.Compartment.empty(0, 0);
        proteinMonomerCoefficients  = [];

        proteinComplexs             = edu.jiangnan.fmme.cell.kb.ProteinComplex.empty(0, 0);
        proteinComplexCompartments  = edu.jiangnan.fmme.cell.kb.Compartment.empty(0, 0);
        ...
        complexFormationProcess      = edu.jiangnan.fmme.cell.kb.Process.empty(0, 0); %process where complex is formed
    end
    ...
    methods
        function this = ProteinComplex(knowledgeBase, wid, wholeCellModelID, name,...
            ...
            this = edu.jiangnan.fmme.cell.kb.ProteinComplex.empty(size(wid, 1), 0);
            this(size(wid, 1), 1) = edu.jiangnan.fmme.cell.kb.ProteinComplex;
            for i = 1:size(wid, 1)
                this(i, 1).idx = i;
