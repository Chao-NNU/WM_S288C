...
classdef Polymer < edu.jiangnan.fmme.cell.kb.PhysicalObject
    ...
    methods
        function this = Polymer(knowledgeBase, wid, wholeCellModelID, name, sequenceLength, sequence, ...
                comments, crossReferences)
            
            if nargin == 0; return; end;
            
            this = edu.jiangnan.fmme.cell.kb.Polymer.empty(size(wid,1),0);
            this(size(wid,1),1) = edu.jiangnan.fmme.cell.kb.Polymer;
            for i = 1:size(wid,1)
                this(i,1).idx = i;
