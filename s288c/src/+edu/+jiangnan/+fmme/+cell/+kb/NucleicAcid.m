...
classdef NucleicAcid < edu.jiangnan.fmme.cell.kb.Polymer
    %computed properties
    ...
    methods
        function this = NucleicAcid(knowledgeBase, wid, wholeCellModelID, name,...
            ...
            this = edu.jiangnan.fmme.cell.kb.NucleicAcid.empty(size(wid,1),0);
            this(size(wid,1),1) = edu.jiangnan.fmme.cell.kb.NucleicAcid;
            for i=1:size(wid,1)
                this(i,1).idx = i;
