...
%   References
%   ===============
%   1. Chambaud I, Wr?blewski H, Blanchard A (1999). Interactions between
...
%      [PUB_0655]
%   3. Muhlradt PF, Kiess M, Meyer H, S?ssmuth R, Jung G (1997). Isolation,
...
classdef  ProteinProcessingII < edu.jiangnan.fmme.cell.sim.Process
    ...
    properties
        ...
        enzymeWholeCellModelIDs = { %enzyme whole cell model ids
            'YIR022W_YJR010C-A_YML055W_YLR066W_TETRAMER';       %prolipoprotein signal peptidase, signal peptidase complex
            'YJL062W_MONOMER'        							%prolipoprotein diacylglyceryl transferase
            };
