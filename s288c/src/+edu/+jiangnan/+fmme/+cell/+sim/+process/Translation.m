...
classdef Translation < edu.jiangnan.fmme.cell.sim.Process
    ...
    properties
        ...
        substrateWholeCellModelIDs = { %whole cell model IDs of substrates
            'ALA_L'; 'ARG_L'; 'ASN_L'; 'ASP_L'; 'CYS_L'; 'GLN_L'; 'GLU_L'; 'GLY_L'; 'HIS_L'; 'ILE_L';
            'LEU_L'; 'LYS_L'; 'MET_L'; 'PHE_L'; 'PRO_L'; 'SER_L'; 'THR_L'; 'TRP_L'; 'TYR_L'; 'VAL_L'; 'ATP'; 'ADP';
            'GTP'; 'GDP'; 'PI'; 'H2O'; 'H'};
        substrateIndexs_aminoAcids  = (1:20)'; %indices within substrates of amino acids
        substrateIndexs_atp         = 21;      %index within substrates of ATP
		substrateIndexs_adp         = 22;      %index within substrates of ADP
        substrateIndexs_gtp         = 23;      %index within substrates of GTP
        substrateIndexs_gdp         = 24;      %index within substrates of GDP
        substrateIndexs_phosphate   = 25;      %index within substrates of phosphate
        substrateIndexs_water       = 26;      %index within substrates of water
        substrateIndexs_hydrogen    = 27;      %index within substrates of hydrogen

        enzymeWholeCellModelIDs = { 		   						%whole cell model ids of enzymes
			'YNL244C_MONOMER'; 						   			    %translation initiation factor eIF-1
			'YJR007W_YPL237W_YER025W_TRIMER';						%translation initiation factor eIF-2 complex	
			'YBR079C_YDR429C_YLR192C_YMR146C_YMR309C_YOR361C_6MER'; %translation initiation factor eIF-3 complex			
			'YLR069C_MONOMER';										%translation elongation factor G1
			'YOR133W_MONOMER';										%translation elongation factor 2-1
			'YLR249W_MONOMER';										%translation elongation factor 3A
			'YOR187W_MONOMER';										%translation elongation factor Tu
			'YBR143C_MONOMER';										%Eukaryotic peptide chain release factor
			'YHR038W_MONOMER';										%Ribosome-recycling factor, mitochondrial	
			'RIBOSOME_40S';  										%40S ribosomal subunit
			'RIBOSOME_40S_IF2'; 									%40S ribosomal subunit - translation initiation factor IF-2 complex
			'RIBOSOME_60S';   										%60S ribosomal subunit
			'RIBOSOME_80S';   										%80S ribosome
			'YHR189W_MONOMER';										%Peptidyl-tRNA hydrolase 1
			'YBL057C_MONOMER';		   								%Peptidyl-tRNA hydrolase 2	
			'YAL005C_MONOMER';										%Heat shock protein SSA1
			'YDL229W_MONOMER'};										%Ribosome-associated molecular chaperone SSB1
		...
		enzymeIndexs_initiationFactor2complex    = 2;          %index within enzymes of initiation factor 2
		...
		enzymeIndexs_elongationFactorG1			 = 4;         %index within enzymes of elongation factor G1
        enzymeIndexs_terminationFactor           = 8;		   %index within enzymes of eukaryotic peptide chain release factor		
        enzymeIndexs_recyclingFactor             = 9;         %index within enzymes of recylcing factor		
        enzymeIndexs_ribosome40S                 = 10;         %index within enzymes of 40S ribosomal particle
        enzymeIndexs_ribosome40SIF2              = 11;         %index within enzymes of 40S ribosomal particle-initiation factor 2 complex
        enzymeIndexs_ribosome60S                 = 12;         %index within enzymes of 60S ribosomal particle
        enzymeIndexs_ribosome80S                 = 13;         %index within enzymes of 80S ribosome
        enzymeIndexs_abortiveTranslationEnzymes  = (14:17)';   %indices within enzymes of abortive translation enzymes
        enzymeIndexs_peptidylTRNAHydrolase1      = 14;         %index within enzymes of peptidyl-tRNA hydrolase 1
		enzymeIndexs_peptidylTRNAHydrolase2      = 15;         %index within enzymes of peptidyl-tRNA hydrolase 2
		enzymeIndexs_SSA1		 				 = 16;		   %index within enzymes of Heat shock protein SSA1 				
		enzymeIndexs_SSB1						 = 17;		   %index within enzymes of Ribosome-associated molecular chaperone SSB1
    ...
    methods
        ...
        function [bmProd, byProd, minEnzExp, maxEnzExp] = calcResourceRequirements_LifeCycle(this, ~, states)
            ...
            minEnzExp(this.enzymeIndexs_ribosome40S) = 1.65 * aaPolymerized0 / this.ribosomeElongationRate / (1 - fractionInitiating);
            minEnzExp(this.enzymeIndexs_ribosome60S) = 1.65 * aaPolymerized0 / this.ribosomeElongationRate / (1 - fractionInitiating);

            %initiation, elongation, termination factors
            minEnzExp(this.enzymeIndexs_initiationFactors)     = 3 * minEnzExp(this.enzymeIndexs_ribosome40S) *      fractionInitiating;
            minEnzExp(this.enzymeIndexs_elongationFactors)     = 3 * minEnzExp(this.enzymeIndexs_ribosome40S) * (1 - fractionInitiating);
            minEnzExp(this.enzymeIndexs_terminationFactor)     = 3;
            minEnzExp(this.enzymeIndexs_recyclingFactor)       = 3;
            minEnzExp(this.enzymeIndexs_elongationFactorG1)    = 3 + minEnzExp(this.enzymeIndexs_elongationFactorG1);

            %abortive translation enzymes
            %minEnzExp(this.enzymeIndexs_tmRNA)                 = 3;
            %minEnzExp(this.enzymeIndexs_tmRNABindingProtein)   = 3;
			minEnzExp(this.enzymeIndexs_SSA1)				    = 3;
			minEnzExp(this.enzymeIndexs_SSB1)				    = 3;
            minEnzExp(this.enzymeIndexs_peptidylTRNAHydrolase1) = 3;
			minEnzExp(this.enzymeIndexs_peptidylTRNAHydrolase2) = 3;
        end
        ...
        function initializeState(this)
            ...
            this.boundEnzymes(:) = 0;
            this.enzymes(this.enzymeIndexs_ribosome40S) = this.enzymes(this.enzymeIndexs_ribosome40S) + this.enzymes(this.enzymeIndexs_ribosome80S);
            this.enzymes(this.enzymeIndexs_ribosome60S) = this.enzymes(this.enzymeIndexs_ribosome60S) + this.enzymes(this.enzymeIndexs_ribosome80S);
            this.enzymes(this.enzymeIndexs_ribosome80S) = 0;
            this.enzymes(this.enzymeIndexs_ribosome40S) = this.enzymes(this.enzymeIndexs_ribosome40S) + this.enzymes(this.enzymeIndexs_ribosome40SIF2);
            this.enzymes(this.enzymeIndexs_initiationFactor3) = this.enzymes(this.enzymeIndexs_initiationFactor3) + this.enzymes(this.enzymeIndexs_ribosome40SIF2);
            this.enzymes(this.enzymeIndexs_ribosome40SIF2) = 0;
            ...
            ribosome40S             = this.enzymes(this.enzymeIndexs_ribosome40S);
            ribosome40SIF2          = this.enzymes(this.enzymeIndexs_ribosome40SIF2);
            ribosome60S             = this.enzymes(this.enzymeIndexs_ribosome60S);
            ribosome80S             = this.enzymes(this.enzymeIndexs_ribosome80S);

            boundRibosome80S = min([
                ribosome40S;
                ribosome60S;
                freeTranslationFactors(this.enzymeIndexs_elongationFactors);
                sum(this.mRNAs)]);
			
            ribosome40S = ribosome40S - boundRibosome80S;
            ribosome60S = ribosome60S - boundRibosome80S;
            freeTranslationFactors(this.enzymeIndexs_elongationFactors)  = freeTranslationFactors(this.enzymeIndexs_elongationFactors)  - boundRibosome80S;
            boundTranslationFactors(this.enzymeIndexs_elongationFactors) = boundTranslationFactors(this.enzymeIndexs_elongationFactors) + boundRibosome80S;

            %allocate
            rib.states                = repmat(rib.notExistValue, [2*boundRibosome80S, 1, 1]);
            pol.boundMRNAs            = zeros(2 * boundRibosome80S, 1, 1);
            pol.nascentMonomerLengths = zeros(2 * boundRibosome80S, 1, 1);
            pol.proteolysisTagLengths = zeros(2 * boundRibosome80S, 1, 1);

            %bind random mRNA
            for i = 1:boundRibosome80S
            ...
            this.enzymes(this.enzymeIndexs_ribosome40S)             = ribosome40S;
            this.enzymes(this.enzymeIndexs_ribosome40SIF2)          = ribosome40SIF2;
            this.enzymes(this.enzymeIndexs_ribosome60S)             = ribosome60S;
            this.enzymes(this.enzymeIndexs_ribosome80S)             = ribosome80S;
            this.boundEnzymes(this.enzymeIndexs_ribosome80S)        = boundRibosome80S;
            ...
            mon.counts = ...
                + mon.counts; ...
                %+ mon.updateExternalState{1}(-(initMonCnts - mon.counts), true);
            cpx.counts = ...
                + cpx.counts; ...
                %+ cpx.updateExternalState{1}(-(initCpxCnts - cpx.counts), true);
        ...
        function result = calcResourceRequirements_Current(this)
            ...
            ribosome60S       = this.enzymes(this.enzymeIndexs_ribosome60S);
            nRibosomes = ...
                this.enzymes(this.enzymeIndexs_ribosome80S) + ...
                this.boundEnzymes(this.enzymeIndexs_ribosome80S) + ...
                min(ribosome40SIF2 + min(ribosome40S, initiationFactor3), ribosome60S);
        ...
        function evolveState(this)
            ...
            ribosome60S                = this.enzymes(this.enzymeIndexs_ribosome60S);
            ribosome80S                = this.enzymes(this.enzymeIndexs_ribosome80S);
            boundRibosome80S           = this.boundEnzymes(this.enzymeIndexs_ribosome80S);
            %freeTMRNA                  = this.freeTMRNA; %#ok<*PROP>
            %freeTMRNABindingProtein    = this.enzymes(this.enzymeIndexs_tmRNABindingProtein);
            freePeptidylTRNAHydrolase  = this.enzymes(this.enzymeIndexs_peptidylTRNAHydrolase1);
            %boundTMRNA                 = this.boundTMRNA;
            %aminoacylatedTmRNA         = this.aminoacylatedTMRNA;
            
            % form ribosomes
            new_ribosome40SIF2 = min(ribosome40S, freeTranslationFactors(this.enzymeIndexs_initiationFactor3));
            ribosome40SIF2 = ribosome40SIF2 + new_ribosome40SIF2;
            ribosome40S    = ribosome40S - new_ribosome40SIF2;
            freeTranslationFactors(this.enzymeIndexs_initiationFactor3) = freeTranslationFactors(this.enzymeIndexs_initiationFactor3) - new_ribosome40SIF2;
            
            %allocate space to store states of new ribosomes
            if boundRibosome80S + ribosome40SIF2 > numel(rib.states)
                rib.states = [
                    rib.states;
                    repmat(rib.notExistValue, [boundRibosome80S + ribosome40SIF2 1])];
				
				rib.states	
					
                pol.boundMRNAs = [
                    pol.boundMRNAs;
                    zeros([boundRibosome80S + ribosome40SIF2 1])];
            ...
            randomOrder = this.randStream.randperm(boundRibosome80S);
            ...
            nInitiatingRibosomes = min([
                ...
                freeTranslationFactors(this.enzymeIndexs_initiationFactor2complex);
                max(0, min(availableEnergy, availableWater) - 2 * nElongatingRibosomes);
                sum(this.mRNAs)]);
            if nInitiatingRibosomes > 0
                ribosome40SIF2   = ribosome40SIF2   - nInitiatingRibosomes;
                ribosome60S      = ribosome60S      - nInitiatingRibosomes;
                boundRibosome80S = boundRibosome80S + nInitiatingRibosomes;
            ...
            for idx = 1:length(elngRibs)
                ...
                if elngRibs(i) && (tmpProg(i) || pol.nascentMonomerLengths(i) >= pol.monomerLengths(pol.boundMRNAs(i)))
                    if (pol.nascentMonomerLengths(i) >= pol.monomerLengths(pol.boundMRNAs(i)) || ...
                            ...
                            (freeTranslationFactors(this.enzymeIndexs_elongationFactorG1) || tmpProg(i)) && ...
                            freeTranslationFactors(this.enzymeIndexs_initiationFactor3) && ...
                            availableEnergy >= 2 && ...
                            availableWater >= 2
                        ...
                        boundRibosome80S = boundRibosome80S - 1;
                        ribosome40S      = ribosome40S      + 1;
                        ribosome60S      = ribosome60S      + 1;
                    end
            ...
            this.enzymes(this.enzymeIndexs_peptidylTRNAHydrolase1)      = freePeptidylTRNAHydrolase;
