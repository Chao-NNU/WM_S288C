...
classdef  ChromosomeSegregation < edu.jiangnan.fmme.cell.sim.Process & edu.jiangnan.fmme.cell.sim.ChromosomeProcessAspect
    ...
    properties
        ...
        enzymeWholeCellModelIDs = {                    					%whole cell model IDs of enzymes
            'APC_C_COMPLEX';                            				%APC/C complex
			'YOR026W_YGR188C_6MER';                     				%SAC complex
			'YGR098C_MONOMER';	                       					%separase Esp1
			'YDR113C_MONOMER';                          				%securin Pds1
            'YNL088W_DIMER'}; 	                       					%DNA topoisomerase II
            
        enzymeIndexs_APC_C         = 1;
        enzymeIndexs_SAC           = 2;
        enzymeIndexs_Esp1          = 3;
        enzymeIndexs_Pds1          = 4;
        enzymeIndexs_topoII        = 5;
    end
    ...
    methods
        ...
        function result = calcResourceRequirements_Current(this)
			...
			for i = 1:16
				if ...
                    ~c.segregated && ...
                    collapse(c.polymerizedRegions{i}) == c.nCompartments * c.sequenceLen(i) && ...
                    all(this.enzymes)
