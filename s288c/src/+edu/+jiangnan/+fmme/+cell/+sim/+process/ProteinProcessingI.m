...
classdef ProteinProcessingI < edu.jiangnan.fmme.cell.sim.Process
    ...
    properties
        ...
        enzymeWholeCellModelIDs={       %enzyme whole cell model ids
            ...
            'YLR244C_MONOMER'};			%methionine aminopeptidase, type I	
			
        %enzymeIndexs_deformylase             = 1; %index within enzymes of peptide deformylase
        enzymeIndexs_methionineAminoPeptidase = 1; %index within enzymes of methionine aminopeptidase, type I
    ...
    methods
        ...
        function result = calcResourceRequirements_Current(this)
            ...
            result(this.substrateIndexs_water) = min(...
				+ min(cleavageLimit, this.nascentMonomerNTerminalMethionineCleavages' * this.unprocessedMonomers));
