...
classdef Simulation < handle
    ...
    properties (SetAccess = private)
        lengthSec   = 8000; %length of simulation (s); ~1.5x 1.5 h doubling time
    ...
    methods
        function this = Simulation(kbStates, kbProcesses)
            ...
            %construct constants
            this.compartment = edu.jiangnan.fmme.cell.sim.constant.Compartment();
            this.gene = edu.jiangnan.fmme.cell.sim.constant.Gene();
    ...
    methods
        ...
        function constructRandStream(this)
            %seed private stream
            this.randStream = edu.jiangnan.fmme.util.RandStream('mcg16807');
    ...
    methods (Access = protected)
        function this = constructStates(this, stateWholeCellModelIDs)
            ...
            for i = 1:numel(stateWholeCellModelIDs)
                constructor = str2func(...
                    ['edu.jiangnan.fmme.cell.sim.state.' this.stateMetadata.classes{map(i)}]);
        ...
        function this = constructProcesses(this, processWholeCellModelIDs)
            ...
            if ~isempty(map)
                ...
                for i = 1:length(map)
                    constructor = str2func(...
                        ['edu.jiangnan.fmme.cell.sim.process.' this.processMetadata.classes{map(i)}]);
