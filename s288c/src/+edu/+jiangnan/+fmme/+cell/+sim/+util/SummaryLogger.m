...
classdef SummaryLogger < edu.jiangnan.fmme.cell.sim.util.Logger
    %options
    ...
    methods
        ...
        function this = initialize(this, sim)
            ...
            this.log.supercoiled{1}        = zeros(2, nSeg, 'double');         %number of supercoiled regions
            this.log.supercoiled{2}        = zeros(2, nSeg, 'double');         %number of supercoiled regions			
            this.log.supercoiled{3}        = zeros(2, nSeg, 'double');         %number of supercoiled regions			
            this.log.supercoiled{4}        = zeros(2, nSeg, 'double');         %number of supercoiled regions			
            this.log.supercoiled{5}        = zeros(2, nSeg, 'double');         %number of supercoiled regions			
            this.log.supercoiled{6}        = zeros(2, nSeg, 'double');         %number of supercoiled regions			
            this.log.supercoiled{7}        = zeros(2, nSeg, 'double');         %number of supercoiled regions			
            this.log.supercoiled{8}        = zeros(2, nSeg, 'double');         %number of supercoiled regions			
            this.log.supercoiled{9}        = zeros(2, nSeg, 'double');         %number of supercoiled regions			
            this.log.supercoiled{10}       = zeros(2, nSeg, 'double');         %number of supercoiled regions	
            this.log.supercoiled{11}       = zeros(2, nSeg, 'double');         %number of supercoiled regions			
            this.log.supercoiled{12}       = zeros(2, nSeg, 'double');         %number of supercoiled regions
            this.log.supercoiled{13}       = zeros(2, nSeg, 'double');         %number of supercoiled regions
            this.log.supercoiled{14}       = zeros(2, nSeg, 'double');         %number of supercoiled regions			
            this.log.supercoiled{15}       = zeros(2, nSeg, 'double');         %number of supercoiled regions			
            this.log.supercoiled{16}       = zeros(2, nSeg, 'double');         %number of supercoiled regions
            this.log.dnaA                  = zeros(2, nSeg, 'int16');          %numbers of free and total DnaA monomers
            this.log.dnaAFunctionalBoxes{1}   = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes
			this.log.dnaAFunctionalBoxes{2}   = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes
			this.log.dnaAFunctionalBoxes{3}   = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{4}   = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{5}   = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{6}   = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{7}   = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{8}   = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{9}   = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{10}  = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{11}  = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{12}  = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{13}  = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{14}  = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{15}  = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
			this.log.dnaAFunctionalBoxes{16}  = zeros(5, nSeg, 'int8');           %polymerization status of R1-5 functional DnaA boxes			
            this.log.replisome{1}          = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases
            this.log.replisome{2}          = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{3}          = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{4}          = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{5}          = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{6}          = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{7}          = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{8}          = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{9}          = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{10}         = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{11}         = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{12}         = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{13}         = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{14}         = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{15}         = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            this.log.replisome{16}         = zeros(6, nSeg, 'int32');          %positions of helicase and leading and lagging polymerases			
            ...
            this.log.ploidy{1}             = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)
            this.log.ploidy{2}             = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)			
            this.log.ploidy{3}             = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)
            this.log.ploidy{4}             = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)
            this.log.ploidy{5}             = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)			
            this.log.ploidy{6}             = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)			
            this.log.ploidy{7}             = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)
            this.log.ploidy{8}             = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)			
            this.log.ploidy{9}             = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)			
            this.log.ploidy{10}            = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)
            this.log.ploidy{11}            = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)			
            this.log.ploidy{12}            = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)			
            this.log.ploidy{13}            = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)
            this.log.ploidy{14}            = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)			
            this.log.ploidy{15}            = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)			
            this.log.ploidy{16}            = zeros(1, nSeg, 'double');         %ploidy (genetic content--should range from 1 to 2)			
        ...
        function appendHelper(this, i, sim)
            ...
            iMembrane = sim.compartment.mitochondriaIndexs;
			...
			this.log.metabolites(10,i) = sum(m.counts(m.lipidIndexs, iCytosol));
            ...
            if this.processIndex_transcription
                ...
                this.log.rnaPolymerases(1, i) = ...
                    + transcription.enzymes(transcription.enzymeIndexs_rnaPolymerase2) ...
                    + transcription.enzymes(transcription.enzymeIndexs_rnaPolymerase3) ...
                    + transcription.boundEnzymes(transcription.enzymeIndexs_rnaPolymerase2) ...
                    + transcription.boundEnzymes(transcription.enzymeIndexs_rnaPolymerase3);
            end
            
            if this.processIndex_translation
                translation = sim.processes{this.processIndex_translation};
                this.log.ribosomes(1, i) = ...
                    + translation.enzymes(translation.enzymeIndexs_ribosome40S) ...
                    + translation.enzymes(translation.enzymeIndexs_ribosome40SIF2) ...
                    + translation.enzymes(translation.enzymeIndexs_ribosome60S) ...
                    + translation.enzymes(translation.enzymeIndexs_ribosome80S) ...
                    + translation.boundEnzymes(translation.enzymeIndexs_ribosome40S) ...
                    + translation.boundEnzymes(translation.enzymeIndexs_ribosome40SIF2) ...
                    + translation.boundEnzymes(translation.enzymeIndexs_ribosome60S) ...
                    + translation.boundEnzymes(translation.enzymeIndexs_ribosome80S);
            end
            
			for j = 1:16
            this.log.supercoiled{j}(1, i) = collapse(c.supercoiled{j}) / 2;
            this.log.supercoiled{j}(2, i) = (collapse(c.linkingNumbers{j}) - collapse(c.polymerizedRegions{j})/c.relaxedBasesPerTurn(j)) / (collapse(c.polymerizedRegions{j})/c.relaxedBasesPerTurn(j));
            end
			...
			for j =1:16
				if this.processIndex_replicationInitiation
					...
					this.log.dnaA(:, i) = [
						repInit.enzymes(repInit.enzymeIndexs_ORC_1mer_ATP)
						[1 1:6 1:6] * (...
						+ repInit.enzymes([repInit.enzymeIndexs_ORC; repInit.enzymeIndexs_ORC_Nmer_ATP; repInit.enzymeIndexs_ORC_Nmer_ADP]) ...
						+ repInit.boundEnzymes([repInit.enzymeIndexs_ORC; repInit.enzymeIndexs_ORC_Nmer_ATP; repInit.enzymeIndexs_ORC_Nmer_ADP]) ...
						)];
					dnaAPol{j} = [
						repInit.calculateDnaAR1234Polymerization(j)
						repInit.calcuateIsDnaAR5Occupied(j)
						];
					
					this.log.dnaAFunctionalBoxes{j}(:, i) = dnaAPol{j}(:, 1);
				end
			end
			...
			for j =1:16
				if this.processIndex_replication
					...
					this.log.replisome{j}(:, i) = [
						rep.helicasePosition{j} rep.leadingPosition{j} rep.laggingPosition{j}
						];
				end
            
				this.log.ploidy{j}(1,i) = c.ploidy{j};
			end
			...
			this.log.pinchedDiameter(1, i) = geometry.daughterwidth;
        end
        ...
        function this = finalize(this, sim)
            ...
            for j = 1:numel(fields)	
				if size(this.log.(fields{j}),2) == 16
				   for k = 1:16
				   this.log.(fields{j}){k} = this.log.(fields{j}){k}(:, 1:i);
				   end
				else  
    ...
    methods (Access = protected)
        function initializePrint(this)
			...
			fprintf('%-5s %-3s %-4s %-10s %-89s %-29s %-11s %-11s %-6s %-7s %-12s %-16s %-6s %-7s %-11s %-10s\n', ...
                '', ...
                '', ...
                '', ...
                '', ...
			...
			fprintf('%-5s %-3s %-4s %-10s %-8s %-8s %-8s %-8s %-9s %-8s %-9s %-8s %-15s %-4s %-4s %-4s %-4s %-4s %-4s %-5s %-5s %-5s %-5s %-6s %-7s %-12s %-16s %-16s %-16s %-9s %-7s %-11s %-10s\n',...
				'Time', ...
				'RT', ... 
				'Mass',...
				'Growth',...
        ...
        function print(this, i)
            ...
            fprintf(format,...
				...
				this.log.supercoiled{1}(1, i),...
				this.log.dnaA(1, i),...
				this.log.dnaA(2, i),...
				this.log.dnaAFunctionalBoxes{1}(1, i),...
				this.log.dnaAFunctionalBoxes{1}(2, i),...
				this.log.dnaAFunctionalBoxes{1}(3, i),...
				this.log.dnaAFunctionalBoxes{1}(4, i),...
				this.log.dnaAFunctionalBoxes{1}(5, i),...
				this.log.replisome{1}(1, i),...
				this.log.replisome{1}(2, i),...
				this.log.replisome{1}(3, i),...
				this.log.replisome{1}(4, i),...
				this.log.replisome{1}(5, i),...
				this.log.replisome{1}(6, i),...
				this.log.ploidy{1}(1,i),...
				this.log.ftsZ(1, i),...
				this.log.ftsZ(2, i),...
        ...
        function plot(this, ~)
            ...
            plot(axesHandle, this.log.time/3600, this.log.supercoiled{1}(1, :)');
            ...
            h = plot(axesHandle, this.log.time/3600, [this.log.dnaA/max(1, this.log.dnaA(1,1)); int16(this.log.dnaAFunctionalBoxes{1})]');
            ...
            h = plot(axesHandle, this.log.time/3600, this.log.replisome{1}');
    ...
    methods (Static = true)
        ...
        function simStats = getSimulationStatistics(baseDir, selectedSimulations)
            ...
            for j = 1:nSimulations
                ...
                elseif exist(sprintf('%s/%d/err.mat', baseDir, i), 'file')
                    ...
                    idx = find(all(summary.dnaAFunctionalBoxes{16} == repmat([6; 6; 6; 6; 1], 1, numel(summary.time)), 1), 1, 'first');
                    if ~isempty(idx)
                        simStats(j, SummaryLogger.SIM_STATUS_INDEX_REP_INIT_TIME) = summary.time(idx);
                    end
                    
                    idx = find(any(summary.replisome{16}, 1), 1, 'first');
                    if ~isempty(idx)
                    ...
                    idx = find(any(summary.replisome{16}, 1), 1, 'last')+1;
        ...
        function value = formatColNames()
            stateColNames = {
                ...
                'R4_16'
                'R5_16'					
                'Helicase Position - 1_01'
                'Helicase Position - 2_01'
				'Helicase Position - 1_02'
				'Helicase Position - 2_02'
				'Helicase Position - 1_03'
				'Helicase Position - 2_03'
				'Helicase Position - 1_04'
				'Helicase Position - 2_04'
				'Helicase Position - 1_05'
				'Helicase Position - 2_05'
				'Helicase Position - 1_06'
				'Helicase Position - 2_06'
				'Helicase Position - 1_07'
				'Helicase Position - 2_07'
				'Helicase Position - 1_08'
				'Helicase Position - 2_08'
				'Helicase Position - 1_09'
				'Helicase Position - 2_09'
				'Helicase Position - 1_10'
                'Helicase Position - 2_10'
				'Helicase Position - 1_11'
				'Helicase Position - 2_11'
				'Helicase Position - 1_12'
				'Helicase Position - 2_12'
				'Helicase Position - 1_13'
				'Helicase Position - 2_13'
				'Helicase Position - 1_14'
				'Helicase Position - 2_14'
				'Helicase Position - 1_15'
				'Helicase Position - 2_15'
				'Helicase Position - 1_16'
				'Helicase Position - 2_16'
                'Leading Polymerase Position - 1_01'
                'Leading Polymerase Position - 2_01'
				'Leading Polymerase Position - 1_02'
                'Leading Polymerase Position - 2_02'
				'Leading Polymerase Position - 1_03'
                'Leading Polymerase Position - 2_03'
				'Leading Polymerase Position - 1_04'
                'Leading Polymerase Position - 2_04'
				'Leading Polymerase Position - 1_05'
                'Leading Polymerase Position - 2_05'
				'Leading Polymerase Position - 1_06'
                'Leading Polymerase Position - 2_06'
				'Leading Polymerase Position - 1_07'
                'Leading Polymerase Position - 2_07'
				'Leading Polymerase Position - 1_08'
                'Leading Polymerase Position - 2_08'
				'Leading Polymerase Position - 1_09'
                'Leading Polymerase Position - 2_09'
				'Leading Polymerase Position - 1_10'
                'Leading Polymerase Position - 2_10'
				'Leading Polymerase Position - 1_11'
                'Leading Polymerase Position - 2_11'
				'Leading Polymerase Position - 1_12'
                'Leading Polymerase Position - 2_12'
				'Leading Polymerase Position - 1_13'
                'Leading Polymerase Position - 2_13'
				'Leading Polymerase Position - 1_14'
                'Leading Polymerase Position - 2_14'
				'Leading Polymerase Position - 1_15'
                'Leading Polymerase Position - 2_15'
				'Leading Polymerase Position - 1_16'
                'Leading Polymerase Position - 2_16'
				'Lagging Polymerase Position - 1_01'
                'Lagging Polymerase Position - 2_01'
				'Lagging Polymerase Position - 1_02'
                'Lagging Polymerase Position - 2_02'
				'Lagging Polymerase Position - 1_03'
                'Lagging Polymerase Position - 2_03'
				'Lagging Polymerase Position - 1_04'
                'Lagging Polymerase Position - 2_04'
				'Lagging Polymerase Position - 1_05'
                'Lagging Polymerase Position - 2_05'
				'Lagging Polymerase Position - 1_06'
                'Lagging Polymerase Position - 2_06'
				'Lagging Polymerase Position - 1_07'
                'Lagging Polymerase Position - 2_07'
				'Lagging Polymerase Position - 1_08'
                'Lagging Polymerase Position - 2_08'
				'Lagging Polymerase Position - 1_09'
                'Lagging Polymerase Position - 2_09'
				'Lagging Polymerase Position - 1_10'
                'Lagging Polymerase Position - 2_10'
				'Lagging Polymerase Position - 1_11'
                'Lagging Polymerase Position - 2_11'
				'Lagging Polymerase Position - 1_12'
                'Lagging Polymerase Position - 2_12'
				'Lagging Polymerase Position - 1_13'
                'Lagging Polymerase Position - 2_13'
				'Lagging Polymerase Position - 1_14'
                'Lagging Polymerase Position - 2_14'
				'Lagging Polymerase Position - 1_15'
                'Lagging Polymerase Position - 2_15'
				'Lagging Polymerase Position - 1_16'
                'Lagging Polymerase Position - 2_16'
                'Ploidy_01'
				'Ploidy_02'
				'Ploidy_03'
				'Ploidy_04'
