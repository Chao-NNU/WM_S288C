...
classdef TimeCourse
    methods (Static)
        function run(sim, fileName)
            import edu.jiangnan.fmme.cell.sim.analysis.TimeCourse;
    ...
    methods (Static)
        ...
        function plotRNAs(sim, axesHandle, time, compartments)
            ...
            values = edu.jiangnan.fmme.cell.sim.util.PlotUtil.selectCompartmentsForPlot(sim, compartments, [
                sum(r.counts, 1);
        ...
        function plotrRNAs(sim, axesHandle, time, compartments)
            ...
            values = edu.jiangnan.fmme.cell.sim.util.PlotUtil.selectCompartmentsForPlot(...
        ...
        function plotRNA_Weight_Fractions(sim, axesHandle, time, compartments)
            ...
            values = edu.jiangnan.fmme.cell.sim.util.PlotUtil.selectCompartmentsForPlot(sim, compartments, weightFractions);
        ...
        function plotNTPs(sim, axesHandle, time, compartments)
            ...
            values = edu.jiangnan.fmme.cell.sim.util.PlotUtil.selectCompartmentsForPlot(sim, compartments, ntpIncorporation);
            plotHandles = plot(axesHandle, time/3600, values);
        ...
        function plotAAs(sim, axesHandle, time, compartments)
            ...
            values=edu.jiangnan.fmme.cell.sim.util.PlotUtil.selectCompartmentsForPlot(sim, compartments, aaIncorporation);
            plotHandles=plot(axesHandle, time/3600, values);
