...
classdef Figures34
    methods (Static = true)
        function run(outDirectory)
            import edu.jiangnan.fmme.cell.sim.analysis.Figures34;
...
%             close(figHandle);
        ...
        function geneToPhenotype(simBatchDir, selectedSim, outDirectory, figHandle, position)
            import edu.jiangnan.fmme.cell.sim.analysis.SingleCell;
            import edu.jiangnan.fmme.cell.sim.util.SimulationDiskUtil;
            import edu.jiangnan.fmme.cell.sim.util.PlotUtil;
        ...
        function circosPlot(simBatchDir, selectedSim, outDirectory, figHandle, position)
            ...
            import edu.jiangnan.fmme.cell.sim.util.SimulationDiskUtil;
            import edu.jiangnan.fmme.cell.sim.util.PlotUtil;
            import edu.jiangnan.fmme.cell.sim.analysis.ChromosomePositionHistogram;
            import edu.jiangnan.fmme.cell.sim.analysis.ChromosomeSpaceTimePlot;
            import edu.jiangnan.fmme.cell.sim.analysis.Figures34;
        ...
        function metabolicMap(simBatchDir, selectedSim, outDirectory, figHandle, position, showAllLabels)
            import edu.jiangnan.fmme.cell.kb.KnowledgeBaseUtil;
            import edu.jiangnan.fmme.cell.sim.util.SimulationEnsemble;
            import edu.jiangnan.fmme.cell.sim.util.SimulationDiskUtil;
            import edu.jiangnan.fmme.cell.sim.util.PlotUtil;
            import edu.jiangnan.fmme.cell.sim.util.PrintUtil;
