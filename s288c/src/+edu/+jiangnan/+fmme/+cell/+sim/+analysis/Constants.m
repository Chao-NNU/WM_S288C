...
classdef Constants
    methods (Static)
        function run(sim, fileName)
            ...
            metaClass = meta.class.fromName('edu.jiangnan.fmme.cell.sim.analysis.Constants');
            ...
            for i = 1:numel(metaClass.Methods)
                ...
                func = str2func(['edu.jiangnan.fmme.cell.sim.analysis.Constants.' metaClass.Methods{i}.Name]);
    ...
    methods (Static)
        ...
        function [content, colLabels, indentation] = printExpectedExpressions(sim)
            ...
            fitter = edu.jiangnan.fmme.cell.sim.util.FitConstants(sim);
    ...
    methods (Static = true)
        ...
        function plotExperimental_Calculated_RNA_Weight_Fraction_Ratios(sim, axesHandle, showLabelsAndLegend)
            ...
            if nargin >= 3 && showLabelsAndLegend
                Constants.labelExperimentalCalculatedBarPlot(axesHandle, x, ratios, ...
                    {'mRNA', 'rRNA 5S', 'rRNA 5.8S', 'rRNA 18S', 'rRNA 25S', 'sRNA', 'tRNA'});
            end
        end
