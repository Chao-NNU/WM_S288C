...
classdef CircularSparseMat < edu.jiangnan.fmme.util.SparseMat
    ...
    methods
        ...
        function this = CircularSparseMat(varargin)
            ...
            this = this@edu.jiangnan.fmme.util.SparseMat(supervarargin{:});
        ...
        function this = normalize(this, reSize, reFind, reSort, oldDims)
            this = this.normalize@edu.jiangnan.fmme.util.SparseMat(reSize, reFind, reSort, oldDims);
        ...
        function tf = isequal(A, B)
            tf = isequal@edu.jiangnan.fmme.util.SparseMat(A, B) && ...
        ...
        function C = tprod(A, B, Aid, Bid)
            ...
            C = tprod@edu.jiangnan.fmme.util.SparseMat(A, B);
        ...
        function this = subsasgn(this, s, rhs)
            ...
            if strcmp(s.type,'.') || strcmp(s.type, '{}')
                this = this.subsasgn@edu.jiangnan.fmme.util.SparseMat(s, rhs);
                return;
            end
        ...
        function value = subsref(this, s)
            %Case 1: Dot reference to properties
            if strcmp(s.type,'.') || strcmp(s.type, '{}')
                value = this.subsref@edu.jiangnan.fmme.util.SparseMat(s);
                return;
            end
