...
classdef Cytokinesis_Test < TestCase
    ...
    methods
        ...
        function testSufficientFtsZ(~)
            import edu.jiangnan.fmme.cell.sim.ProteinGrowth_Test;
    ...
    methods (Static = true)
        function durations = estimateMeanCytokinesisDurationDistribution(nIter, verbosity)
            ...
            for i = 1:nIter
                ...
                durations(i) = edu.jiangnan.fmme.cell.sim.Cytokinesis_Test.sampleCytokinesisDuration(meanFtsZCopyNumber, expectedDuration, maxTime, i, verbosity);
            end
        ...
        function cytokinesisDuration = sampleCytokinesisDuration(meanFtsZCopyNumber, expectedDuration, maxIter, seed, verbosity)
            ...
            edu.jiangnan.fmme.cell.sim.Cytokinesis_Test.seedRandStream(sim, seed);
            ...
            if sim.verbosity > 0
                ...
                fprintf('\t%4s %4s %4s %4s %7s %4s %4s %4s %4s %4s %11s\n', ...
                    ...
                    '====', '====', '====', '====', ...
                    '====', '===========');
                edu.jiangnan.fmme.cell.sim.Cytokinesis_Test.printState(sim, 0, 1);
            end
            for iter = 1:maxIter
                sim.evolveState();
                ...
                if sim.verbosity > 0 && mod(iter, 100) == 1
                    edu.jiangnan.fmme.cell.sim.Cytokinesis_Test.printState(sim, iter, nCycle);
                end
