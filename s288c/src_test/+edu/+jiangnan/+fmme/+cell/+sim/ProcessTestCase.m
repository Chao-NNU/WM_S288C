...
classdef ProcessTestCase < TestCase
    ...
    methods
        function this = ProcessTestCase(name)
            ...
            this.processClass     = edu.jiangnan.fmme.util.substr(class(this), 1, -5);
    ...
    methods
        ...
        function loadTestFixture(this)
            this.process = edu.jiangnan.fmme.cell.sim.ProcessFixture.load(this.process);
        end
    end
    ...
    methods (Sealed)
        function helpTestGeneEssentiality(...
            ...
            baseStates = edu.jiangnan.fmme.util.StructUtil.catstruct(base_globalStates, base_localStates);
            ...
            for i = 1:length(geneWholeCellModelIDs)
                ...
                initialStates = edu.jiangnan.fmme.util.StructUtil.catstruct(base_globalStates, initial_localStates);
