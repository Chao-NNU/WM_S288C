...
classdef DatabaseLogger_Test < TestCase
    ...
    methods
        function testLogging(this)
            ...
            metadata = edu.jiangnan.fmme.cell.sim.util.ConditionSet.parseConditionSet(sim, 'src_test/+edu/+jiangnan/+fmme/+cell/+sim/+util/fixtures/runSimulations.xml').metadata;
