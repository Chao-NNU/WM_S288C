...
classdef FitConstants_Test < TestCase
    ...
    methods
        ...
        function setUp(this)
            ...
            this.simulation = sim;
            this.fitter = edu.jiangnan.fmme.cell.sim.util.FitConstants(sim, struct('verbosity', 0));
        end
    ...
    methods
        ...
        function testCalcResourceRequirements(this)
            ...
            invMat = edu.jiangnan.fmme.util.ComputationUtil.invertCompositionMatrix(r.nascentRNAMatureRNAComposition);
