...
classdef ConditionSet_Test < TestCase
    ...
    methods
        ...
        function testParseConditionSet(this)
            expectedConditionSet = this.getTestConditionSet();
            fileName = 'src_test/+edu/+jiangnan/+fmme/+cell/+sim/+util/fixtures/runSimulations.xml';
            conditionSet = edu.jiangnan.fmme.cell.sim.util.ConditionSet.parseConditionSet(this.simulation, fileName);
