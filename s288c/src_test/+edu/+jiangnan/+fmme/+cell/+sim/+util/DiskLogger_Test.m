...
classdef DiskLogger_Test < TestCase
    ...
    methods
        function testLogging(this)
            ...
            metadata = edu.jiangnan.fmme.cell.sim.util.ConditionSet.parseConditionSet(...
        ...
        function testEarlyTermination(this)
            ...
            metadata = edu.jiangnan.fmme.cell.sim.util.ConditionSet.parseConditionSet(sim, 'src_test/+edu/+stanford/+covert/+cell/+sim/+util/fixtures/runSimulations.xml').metadata;
            metadata.knowledgeBaseWID = 145;
