...
classdef Simulation_Integrated_Test < TestCase
    ...
    methods
        ...
        function helpChromosome_testInitializeState(this)
            ...
            assertEqual(edu.jiangnan.fmme.util.CircularSparseMat(posStrnds, iMet, [chrLen 4], 1), s.damagedBases);
        ...
        function helpGrowth_testInitializeState(this)
            ...
            assertElementsAlmostEqual(edu.jiangnan.fmme.cell.sim.process.Metabolism_Test.expected_growthRate, s.growth, 'relative', 0.50, 0);
        end
    ...
    methods
        ...
        function testMetabolism(this)
            ...
            %check growth rate
            assertElementsAlmostEqual(edu.jiangnan.fmme.cell.sim.process.Metabolism_Test.expected_growthRate, ...
