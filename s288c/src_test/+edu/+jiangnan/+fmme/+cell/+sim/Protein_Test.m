...
classdef Protein_Test < TestCase
    ...
    methods
        ...
        function setUp(this)
            this.simulation = edu.jiangnan.fmme.cell.sim.SimulationFixture.load([], {
                'Metabolism'
                'tRNAAminoacylation'
                ...
                'RibosomeAssembly'
        ...
        function testSynthesisPathway(this)
            ...
            j = edu.jiangnan.fmme.cell.sim.constant.Condition.valueIndexs;
    ...
    methods
        function testAminoacylation1(~)
            ...
            s = edu.jiangnan.fmme.cell.sim.SimulationFixture.load([], {
                'tRNAAminoacylation'
                });
        ...
        function testAminoacylation3(~)
            ...
            initRnas = rna.expression * mass.cellInitialDryWeight * mass.dryWeightFractionRNA / ...
                (rna.expression' * rna.molecularWeights / edu.jiangnan.fmme.util.ConstantUtil.nAvogadro);
        ...
        function testAminoacylation5(~)
            ...
            initExpMons = pm.randStream.stochasticRound(mRNAExp * mass.cellInitialDryWeight * mass.dryWeightFractionProtein / ...
                (mRNAExp' * pm.molecularWeights(pm.nascentIndexs) / edu.jiangnan.fmme.util.ConstantUtil.nAvogadro));
        ...
        function testSynthesisAndDecay_FewModules(this)
            ...
            rnaExp = rna.expression;
            rnaMWs = rna.molecularWeights;
            initRNAs = rnaExp * sum(rna.dryWeight) / (rnaExp' * rnaMWs / edu.jiangnan.fmme.util.ConstantUtil.nAvogadro);
            rna.counts(rna.matureIndexs(rna.matureMRNAIndexs), comp.cytosolIndexs) = ...
            ...
            assertIn((ta.substrates(ta.substrateIndexs_aminoAcids)' * ta.substrateMolecularWeights(ta.substrateIndexs_aminoAcids)) / ...
                (sum(pm.dryWeight + pc.dryWeight)*edu.jiangnan.fmme.util.ConstantUtil.nAvogadro), ...
                [0 0.01]);
        end
    end
