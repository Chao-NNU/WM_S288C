...
classdef ReplicationInitiation_Test < edu.jiangnan.fmme.cell.sim.ProcessTestCase
    methods
        function this = ReplicationInitiation_Test(name)
            this = this@edu.jiangnan.fmme.cell.sim.ProcessTestCase(name);
        end
    end
    
    methods
        function loadTestFixture(this)
            this.loadTestFixture@edu.jiangnan.fmme.cell.sim.ProcessTestCase();
    ...
    methods
        ...
        function testDuration(this)
            ...
            %parameter values
            duration = edu.jiangnan.fmme.cell.sim.process.ReplicationInitiation_Test.sampleDuration(...
    ...
    methods (Static)
        function [meanDnaACopyNumber, siteCooperativity, stateCooperativity, nDnaABoxes] = ...
            ...
            import edu.jiangnan.fmme.cell.sim.process.ReplicationInitiation_Test;
            import edu.jiangnan.fmme.util.ComputationUtil;
            
            nTrials = 32;
            sim = edu.jiangnan.fmme.cell.sim.SimulationFixture.load([], {'ReplicationInitiation'});
        ...
        function diff = fitDuration_diff(expectedDuration, meanDnaACopyNumber, siteCooperativity, stateCooperativity, nDnaABoxes, ...
            ...
            [durations, dnaACopyNumbers] = edu.jiangnan.fmme.cell.sim.process.ReplicationInitiation_Test.meanDuration(...
                meanDnaACopyNumber, siteCooperativity, stateCooperativity, nDnaABoxes, ...
                nTrials, maxTime, stepSizeSec, growthFunc, useCommonInitialState, verbosity);
        ...
        function [durations, dnaACopyNumbers] = meanDuration(meanDnaACopyNumber, siteCooperativity, stateCooperativity, nDnaABoxes, ...
            ...
            seeds = (1:nTrials)';
            parfor k = 1:nTrials
                [durations(k), dnaACopyNumbers(k)] = edu.jiangnan.fmme.cell.sim.process.ReplicationInitiation_Test.sampleDuration(...
                    meanDnaACopyNumber, siteCooperativity, stateCooperativity, nDnaABoxes, ...
        ...
        function [replicationInitiationTime, dnaACopyNumber] = sampleDuration(meanDnaACopyNumber, siteCooperativity, stateCooperativity, nDnaABoxes, ...
            ...
            if ~isempty(growthFunc)
                edu.jiangnan.fmme.cell.sim.process.ReplicationInitiation_Test.seedRandStream(sim, initSeed);
                sim.initializeState();
                ...
                while true
                    if initSeed
                        edu.jiangnan.fmme.cell.sim.process.ReplicationInitiation_Test.seedRandStream(sim, initSeed + i);
                    end
            ...
            %% seed
            edu.jiangnan.fmme.cell.sim.process.ReplicationInitiation_Test.seedRandStream(sim, seed);
