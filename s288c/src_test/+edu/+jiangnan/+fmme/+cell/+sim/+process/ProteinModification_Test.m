...
classdef ProteinModification_Test < edu.jiangnan.fmme.cell.sim.ReactionProcessTestCase
    ...
    methods
        function this = ProteinModification_Test(name)
            this = this@edu.jiangnan.fmme.cell.sim.ReactionProcessTestCase(name);
        end
    end

    methods
        function loadTestFixture(this)
            this.loadTestFixture@edu.jiangnan.fmme.cell.sim.ReactionProcessTestCase();
