...
classdef CellStateTestCase < TestCase
    ...
    methods
        function this = CellStateTestCase(name)
            ...
            this.stateClass     = edu.jiangnan.fmme.util.substr(class(this), 1, -5);
    ...
    methods
        ...
        function loadTestFixture(this)
            this.state = edu.jiangnan.fmme.cell.sim.CellStateFixture.load(this.state);
        end
    end
    ...
    methods
        function testImplementsStateInterface(this)
            import edu.jiangnan.fmme.util.InterfaceUtil;
