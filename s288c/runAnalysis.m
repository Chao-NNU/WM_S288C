...
if allSingleGeneDeletions
    ...
    md1 = meta.class.fromName('edu.jiangnan.fmme.cell.sim.analysis.SingleCell');
    md2 = meta.class.fromName('edu.jiangnan.fmme.cell.sim.analysis.Population');
...
for i = 1:size(analysisFunc, 1)
    try
        edu.jiangnan.fmme.cell.sim.(analysisFunc{i, 1}).(analysisFunc{i, 2}).(analysisFunc{i, 3})(analysisFunc{i, 4}{:});
    catch exception
